...
This how-to guide provides instructions on how to submit, or push, a sponsored transaction using the `cleos` CLI tool.
...
You can create the JSON snippet defining the transaction in two ways. In each case include the sponsorship information in the `transaction_extensions` array object. You can add only one transaction sponsorship per transaction.
