...
## Command
A set of APIFINY keys is required to create an account. A set of APIFINY keys can be generated by using `./clapifiny create key`.

```shell
$ ./clapifiny create account inita tester APIFINY4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq APIFINY7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
