...
from cli.eth_swap_contract.help import PERMISSION_ARGUMENT_HELP_MESSAGE
from cli.remchain_swap_contract.help import RECEIVER_ARGUMENT_HELP_MESSAGE, \
    ACCOUNT_NAME_TO_CREATE_ARGUMENT_HELP_MESSAGE, SWAP_TXID_ARGUMENT_HELP_MESSAGE, CHAIN_ID_ARGUMENT_HELP_MESSAGE, \
    SWAP_PUBKEY_ARGUMENT_HELP_MESSAGE, AMOUNT_TO_SWAP_ARGUMENT_HELP_MESSAGE, TIMESTAMP_ARGUMENT_HELP_MESSAGE, \
...
from cli.utils import get_default_nodeos_url, get_default_eth_provider, get_default_permission
...
@click.option('--txid', type=str, required=True, help=SWAP_TXID_ARGUMENT_HELP_MESSAGE)
