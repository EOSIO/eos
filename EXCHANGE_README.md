...
## Initial Condition
```
./enucli get currency balance enumivo.token scott ENU
900.0000 ENU
```
...
#   enumivo.token <= enumivo.token::transfer        {"from":"scott","to":"exchange","quantity":"1.0000 ENU","memo":""}
>> transfer
#         scott <= enumivo.token::transfer        {"from":"scott","to":"exchange","quantity":"1.0000 ENU","memo":""}
#      exchange <= enumivo.token::transfer        {"from":"scott","to":"exchange","quantity":"1.0000 ENU","memo":""}
...
================================================================================================================
#    0   2018-04-29T01:09:45.000     enumivo.token::transfer => exchange      5ec79717... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
```
...
================================================================================================================
#    0   2018-04-29T01:09:45.000     enumivo.token::transfer => exchange      5ec79717... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
#    1   2018-04-29T01:16:25.000     enumivo.token::transfer => exchange      2269828c... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
?    2   2018-04-29T01:19:54.000     enumivo.token::transfer => exchange      213f3797... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
```
...
```
./enucli get currency balance enumivo.token exchange ENU
3.0000 ENU
```
...
#   enumivo.token <= enumivo.token::transfer        {"from":"exchange","to":"scott","quantity":"1.0000 ENU","memo":""}
>> transfer
#      exchange <= enumivo.token::transfer        {"from":"exchange","to":"scott","quantity":"1.0000 ENU","memo":""}
#         scott <= enumivo.token::transfer        {"from":"exchange","to":"scott","quantity":"1.0000 ENU","memo":""}
warning: transaction executed locally, but may not be confirmed by the network yet
```
...
#    1   2018-04-29T01:16:25.000     enumivo.token::transfer => exchange      2269828c... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
#    2   2018-04-29T01:19:54.000     enumivo.token::transfer => exchange      213f3797... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
#    3   2018-04-29T01:53:57.000     enumivo.token::transfer => exchange      8b7766ac... {"from":"scott","to":"exchange","quantity":"1.0000 ENU","mem...
#    4   2018-04-29T01:54:17.500     enumivo.token::transfer => enumivo.token   93e78520... {"from":"exchange","to":"scott","quantity":"1.0000 ENU","mem...
#    5   2018-04-29T01:54:17.500     enumivo.token::transfer => exchange      93e78520... {"from":"exchange","to":"scott","quantity":"1.0000 ENU","mem...
#    6   2018-04-29T01:54:17.500     enumivo.token::transfer => scott         93e78520... {"from":"exchange","to":"scott","quantity":"1.0000 ENU","mem...
```
