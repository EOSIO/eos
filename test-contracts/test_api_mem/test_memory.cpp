...
void test_memory::test_memory_allocs()
{
    ...
    eosio_assert( ptr1_realloc != nullptr, "should have returned a 30 char buf" );
    eosio_assert( ptr1_realloc == ptr1, "should have increased the buf back to orig max"); //test specific to implementation (can remove for refacto r)
    ...
    eosio_assert( ptr1_realloc == ptr1, "should have increased char buf to actual size" ); // test specific to implementation (can remove for refacto r)
    ...
    eosio_assert( ptr2 < ptr1_realloc, "should have been created after ptr2" ); // test specific to implementation (can remove for refacto r)
...
void test_memory::test_memory_hunks_disjoint()
{
   ...
   eosio_assert( loop_ptr2[13] + 16 == ptr3, "should allocate the very next ptr after loop_ptr2[13]" ); // test specific to implementation (can remove for refacto r)

   char* ptr4 = (char*)malloc(4);
   eosio_assert( ptr4 != nullptr, "should have allocated a 4 char buf" );
   eosio_assert( ptr2 + 65416 == ptr4, "should allocate the very next ptr after ptr2 in last heap" ); // test specific to implementation (can remove for refacto r)
...
{
    memset( (char *)0, 0xff, 1024 * 1024 * 1024 ); // big memo ry
}
