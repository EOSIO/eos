...
echo "starting launcher service: ./programs/launcher-service/launcher-service --http-server-address=0.0.0.0:1234 --genesis-json=./genesis.json > launcher_service.log 2>&1 &"
