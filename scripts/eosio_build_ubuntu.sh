...
( [[ $NAME == "Ubuntu" ]] && ( [[ "$(echo ${VERSION_ID})" == "16.04" ]] || [[ "$(echo ${VERSION_ID})" == "18.04" ]] ) || [[ $NAME == "Linux Mint" ]] && [[ "$(echo ${VERSION_ID})" == "19.1" ]] ) || ( echo " - You must be running 16.04.x or 18.04.x to install EOSIO." && exit 1 )
