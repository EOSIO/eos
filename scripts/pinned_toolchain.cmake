...
set(CMAKE_C_COMPILER ${EOSIO_INSTALL_LOCATION}/bin/clang)
set(CMAKE_CXX_COMPILER ${EOSIO_INSTALL_LOCATION}/bin/clang++)
set(CMAKE_CXX_STANDARD_INCLUDE_DIRECTORIES \${EOSIO_INSTALL_LOCATION}/include/c++/v1 /usr/local/include /usr/include)
...
set(CMAKE_CXX_STANDARD_LIBRARIES "\${EOSIO_INSTALL_LOCATION}/lib/libc++.a \${EOSIO_INSTALL_LOCATION}/lib/libc++abi.a")