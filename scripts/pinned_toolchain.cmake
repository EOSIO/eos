...
set(CMAKE_C_COMPILER ${OPT_PATH}/clang12/bin/clang)
set(CMAKE_CXX_COMPILER ${OPT_PATH}/clang12/bin/clang++)

set(CMAKE_CXX_STANDARD_INCLUDE_DIRECTORIES ${OPT_PATH}/clang12/include/c++/v1 /usr/local/include /usr/include)
...
set(CMAKE_CXX_STANDARD_LIBRARIES "${OPT_PATH}/clang12/lib/libc++.a ${OPT_PATH}/clang12/lib/libc++abi.a")
