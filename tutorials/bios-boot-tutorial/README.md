...
$ python3 bios-boot-tutorial.py --remcli="remcli --wallet-url http://127.0.0.1:6666 " --remnode=remnode --remvault=remvault --contracts-dir="/EOSIO_CONTRACTS_DIRECTORY/" -a
