...
FC_REFLECT_TEMPLATE((typename T), eosio::trace_api::transaction_trace_base<T>, (id)(actions))
FC_REFLECT_DERIVED_TEMPLATE((typename T), eosio::trace_api::transaction_trace_v0<T>, (eosio::trace_api::transaction_trace_base<T>), )
FC_REFLECT_DERIVED_TEMPLATE((typename T), eosio::trace_api::transaction_trace_v1<T>, (eosio::trace_api::transaction_trace_v0<T>), (status)(cpu_usage_us)(net_usage_words)(signatures)(trx_header))
FC_REFLECT_TEMPLATE((typename T), eosio::trace_api::block_trace_v0<T>, (id)(number)(previous_id)(timestamp)(producer)(transactions))
FC_REFLECT_DERIVED_TEMPLATE((typename T), eosio::trace_api::block_trace_v1<T>, (eosio::trace_api::block_trace_v0<T>), (transaction_mroot)(action_mroot)(schedule_version)(transactions_v1))
