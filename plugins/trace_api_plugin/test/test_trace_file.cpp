...
BOOST_AUTO_TEST_SUITE(slice_tests)
   ...
   BOOST_FIXTURE_TEST_CASE(store_provider_write_read, test_fixture)
   {
      ...
      BOOST_REQUIRE_EQUAL(std::get<block_trace_v1<action_trace_v0>>(*bt_data), bt);

      bt_data = sp.read_data_log(block_nums[1], block_offsets[1]);
      BOOST_REQUIRE(bt_data);
      BOOST_REQUIRE_EQUAL(std::get<block_trace_v1<action_trace_v0>>(*bt_data), bt2);
   ...
   BOOST_FIXTURE_TEST_CASE(test_get_block, test_fixture)
   {
      ...
      BOOST_REQUIRE_EQUAL(std::get<block_trace_v1<action_trace_v0>>(block1_bt), bt);
      ...
      BOOST_REQUIRE_EQUAL(std::get<block_trace_v1<action_trace_v0>>(block2_bt), bt2);
