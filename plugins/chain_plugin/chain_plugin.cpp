...
void read_only::get_contract_query(const read_only::get_contract_query_params& params, chain::plugin_interface::next_function<read_only::get_contract_query_results> next) const {
   try {
      packed_transaction_v0 input_trx_v0;
      auto resolver = make_resolver(db, abi_serializer::create_yield_function( abi_serializer_max_time ));
      packed_transaction_ptr input_trx;
