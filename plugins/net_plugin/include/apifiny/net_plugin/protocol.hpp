...
FC_REFLECT( apifiny::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( apifiny::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( apifiny::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( apifiny::go_away_message, (reason)(node_id) )
FC_REFLECT( apifiny::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( apifiny::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( apifiny::request_message, (req_trx)(req_blocks) )
FC_REFLECT( apifiny::sync_request_message, (start_block)(end_block) )
