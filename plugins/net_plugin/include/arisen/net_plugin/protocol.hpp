...
FC_REFLECT( arisen::chain_size_message,
            ...
            (head_num)(head_id))
FC_REFLECT( arisen::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( arisen::go_away_message, (reason)(node_id) )
FC_REFLECT( arisen::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( arisen::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( arisen::request_message, (req_trx)(req_blocks) )
FC_REFLECT( arisen::sync_request_message, (start_block)(end_block) )
