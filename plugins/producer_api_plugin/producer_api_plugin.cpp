...
void producer_api_plugin::plugin_startup() {
   ...
   app().get_plugin<http_plugin>().add_api({
       ...
       CALL_WITH_400(producer, producer, get_allowlist_blocklist,
            INVOKE_R_V(producer, get_allowlist_blocklist), 201),
       CALL_WITH_400(producer, producer, set_allowlist_blocklist,
            INVOKE_V_R(producer, set_allowlist_blocklist, producer_plugin::allowlist_blocklist), 201),
