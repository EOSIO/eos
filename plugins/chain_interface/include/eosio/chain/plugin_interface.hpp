...
namespace eosio { namespace chain { namespace plugin_interface {
   ...
   namespace incoming {
      ...
      namespace methods {
         ...
         using transaction_sync      = method_decl<chain_plugin_interface, void(const packed_transaction_ptr&, bool, bool, next_function<transaction_trace_ptr>), first_provider_policy>;
      }
   }
