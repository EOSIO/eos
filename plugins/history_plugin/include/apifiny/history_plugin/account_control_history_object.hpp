...
CHAINBASE_SET_INDEX_TYPE( apifiny::account_control_history_object, apifiny::account_control_history_multi_index )

FC_REFLECT( apifiny::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
