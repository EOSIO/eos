...
CHAINBASE_SET_INDEX_TYPE( apifiny::public_key_history_object, apifiny::public_key_history_multi_index )

FC_REFLECT( apifiny::public_key_history_object, (public_key)(name)(permission) )
