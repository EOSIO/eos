  ...
  app().get_plugin<http_plugin>().add_api(
      {CALL(wallet, wallet_mgr, set_timeout,
       ...
       CALL(wallet, wallet_mgr, sign_transaction,
            INVOKE_R_R_R_R(wallet_mgr, sign_transaction,
                           chain::SignedTransaction, flat_set<public_key_type>,
                           chain::chain_id_type)),
       ...
       CALL(wallet, wallet_mgr, lock_all, INVOKE_V_V(wallet_mgr, lock_all)),
       ...
       CALL(wallet, wallet_mgr, list_keys, INVOKE_R_V(wallet_mgr, list_keys)),
