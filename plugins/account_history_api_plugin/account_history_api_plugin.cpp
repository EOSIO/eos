...
void account_history_api_plugin::set_program_options(options_description &,
                                                     options_description &) {}
...
#define CHAIN_RO_CALL(call_name)                                               \
  CALL(account_history, ro_api, account_history_apis::read_only, call_name)
#define CHAIN_RW_CALL(call_name)                                               \
  CALL(account_history, rw_api, account_history_apis::read_write, call_name)
...
void account_history_api_plugin::plugin_startup() {
  ...
  app().get_plugin<http_plugin>().add_api(
      {CHAIN_RO_CALL(get_transaction), CHAIN_RO_CALL(get_transactions),
