...
eosio::session::session<rocks_data_store<Allocator>, cache<Allocator>>
...
BOOST_AUTO_TEST_CASE(session_delete_key_in_child) {
   ...
   verify_keys_exist_datastore(rocks_ds, std::unordered_map<uint16_t, uint16_t>{ { 2, 2003 }, { 4, 2004 } });
}
