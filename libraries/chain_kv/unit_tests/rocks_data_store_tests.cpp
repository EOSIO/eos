...
auto make_rocks_data_store(const std::string name = "testdb") -> rocks_data_store<allocator>
{
...
BOOST_AUTO_TEST_CASE(rocks_data_store_rw_ds_test)
{
  {
    auto datastore1 = b1::session_tests::make_rocks_data_store<boost_memory_allocator>();
    auto datastore2 = b1::session_tests::make_rocks_data_store<boost_memory_allocator>("testdb2");
    make_data_store(datastore1, char_key_values, string_t{});
...

  {
    ...
    auto datastore4 = b1::session_tests::make_rocks_data_store<boost_memory_allocator>("testdb2");
