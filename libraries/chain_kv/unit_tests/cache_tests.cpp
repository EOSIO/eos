...
BOOST_AUTO_TEST_CASE(cache_create_test) {
  auto cache1 = eosio::session_tests::make_cache<boost_memory_allocator>();
  make_data_store(cache1, char_key_values, string_t{});
  verify_equal(cache1, char_key_values, string_t{});

  auto cache2 = eosio::session_tests::make_cache<boost_memory_allocator>();
...
BOOST_AUTO_TEST_CASE(cache_rw_ds_test) {
  ...
  auto cache3 = eosio::session_tests::make_cache<boost_memory_allocator>();
  auto cache4 = eosio::session_tests::make_cache<boost_memory_allocator>();
