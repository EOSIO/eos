...
struct rodeos_db_snapshot {
   ...
   void start_block(const eosio::ship_protocol::get_blocks_result_base_v0& result);
   void end_block(const eosio::ship_protocol::get_blocks_result_base_v0& result, bool force_write);
   void check_write(const eosio::ship_protocol::get_blocks_result_base_v0& result);
...
struct rodeos_filter {
   ...
   void process(rodeos_db_snapshot& snapshot, const eosio::ship_protocol::get_blocks_result_base_v0& result,
