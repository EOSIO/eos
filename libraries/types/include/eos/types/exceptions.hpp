...
FC_DECLARE_DERIVED_EXCEPTION(unknown_type_exception, type_exception, 4010000,
                             "Could not find requested type")
FC_DECLARE_DERIVED_EXCEPTION(duplicate_type_exception, type_exception, 4020000,
...
FC_DECLARE_DERIVED_EXCEPTION(invalid_schema_exception, type_exception, 4050000,
                             "Schema is invalid")
}
} // eos::chain
