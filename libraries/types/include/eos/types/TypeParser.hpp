...
public:
  ...
  virtual bool isValidTypeName(const TypeName &name,
                               bool allowArray = false) const;
  ...
  /**
   * Parses the input stream and populatse the symbol table, the table may be
   * pre-populated
   */
...
public:
  SimpleSymbolTable()
      : known({"Field",     "Struct",        "Asset",         "ShareType",
               "Name",      "FixedString16", "FixedString32", "UInt8",
               "UInt16",    "UInt32",        "UInt64",        "UInt128",
               "Checksum",  "UInt256",       "UInt512",       "Int8",
               "Int16",     "Int32",         "Int64",         "Int128",
               "Int224",    "Int256",        "Int512",        "Bytes",
               "PublicKey", "Signature",     "String",        "Time"}) {}
