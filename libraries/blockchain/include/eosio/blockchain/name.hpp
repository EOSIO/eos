...
#define N(X) eosio::blockchain::string_to_name(#X)
...
namespace fc {
  class variant;
  void to_variant(const eosio::blockchain::name& c, fc::variant& v);
  void from_variant(const fc::variant& v, eosio::blockchain::name& check);
} // fc
