...
template <typename T> struct safe {
  ...
  template <typename O> safe(O o) : value(o) {}
  safe() {}
  ...
  friend bool operator==(const safe &a, const T &b) { return a.value == b; }
  friend bool operator==(const T &a, const safe &b) { return a == b.value; }
  ...
  friend bool operator!=(const safe &a, const safe &b) { return !(a == b); }
  friend bool operator!=(const safe &a, const T &b) { return !(a == b); }
  friend bool operator!=(const T &a, const safe &b) { return !(a == b); }
