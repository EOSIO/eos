 ...
 *
 *  Simply including boost::optional adds 35,000 lines to each object file,
 * using
...
public:
  ...
  optional(optional &o) : _valid(false) {
    if (o._valid)
      new (ptr()) T(*o);
    _valid = o._valid;
  }

  optional(const optional &o) : _valid(false) {
    if (o._valid)
      new (ptr()) T(*o);
    _valid = o._valid;
  }
  ...
  template <typename U> optional(const optional<U> &o) : _valid(false) {
    if (o._valid)
      new (ptr()) T(*o);
    _valid = o._valid;
  }

  template <typename U> optional(optional<U> &o) : _valid(false) {
    if (o._valid) {
      new (ptr()) T(*o);
    }
    _valid = o._valid;
  ...
  template <typename U> optional(U &&u) : _valid(true) {
  ...
  template <typename U> optional &operator=(optional<U> &o) {
    if (this != &o) {
      if (_valid && o._valid) {
        ref() = *o;
