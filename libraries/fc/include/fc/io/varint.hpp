...
struct unsigned_int {
  ...
  template <typename T> unsigned_int(T v) : value(v) {}
...
struct signed_int {
  ...
  template <typename T> signed_int &operator=(const T &v) {
    value = v;
    return *this;
  }
