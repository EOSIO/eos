...
namespace detail {
NO_RETURN void throw_datastream_range_error(const char *file, size_t len,
                                            int64_t over);
}
...
public:
  ...
  inline bool read(char *d, size_t s) {
    ...
    detail::throw_datastream_range_error("read", _end - _start,
                                         int64_t(-((_end - _pos) - 1)));
  }
  ...
  inline bool write(const char *d, size_t s) {
    ...
    detail::throw_datastream_range_error("write", _end - _start,
                                         int64_t(-((_end - _pos) - 1)));
  }
  ...
  inline bool put(char c) {
    ...
    detail::throw_datastream_range_error("put", _end - _start,
                                         int64_t(-((_end - _pos) - 1)));
  }
  ...
  inline bool get(char &c) {
    ...
    detail::throw_datastream_range_error("get", _end - _start,
                                         int64_t(-((_end - _pos) - 1)));
  }
...
inline datastream<ST>& operator<<(datastream<ST>& ds, const
...
template<typename ST, typename T>
inline datastream<ST>& operator>>(datastream<ST>& ds,
boost::multiprecision::number<T>& n) {
   unsigned char data[(std::numeric_limits<decltype(n)>::digits+1)/8];
