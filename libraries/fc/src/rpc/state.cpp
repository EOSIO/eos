...
void state::remove_method(const fc::string &name) { _methods.erase(name); }
...
void state::on_unhandled(
    const std::function<variant(const string &, const variants &)> &unhandled) {
