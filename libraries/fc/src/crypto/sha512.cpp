...
string sha512::str() const { return fc::to_hex((char *)_hash, sizeof(_hash)); }
...
sha512 sha512::hash(const string &s) { return hash(s.c_str(), s.size()); }
...
void sha512::encoder::reset() { SHA512_Init(&my->ctx); }
