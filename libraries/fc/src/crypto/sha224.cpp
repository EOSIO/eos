...
string sha224::str() const { return fc::to_hex((char *)_hash, sizeof(_hash)); }
...
sha224 sha224::hash(const string &s) { return hash(s.c_str(), s.size()); }
...
void sha224::encoder::reset() { SHA224_Init(&my->ctx); }
