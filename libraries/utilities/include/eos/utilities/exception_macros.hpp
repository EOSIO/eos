...
#define EOS_DECLARE_OP_BASE_EXCEPTIONS(op_name)                                \
  FC_DECLARE_DERIVED_EXCEPTION(                                                \
      op_name##_validate_exception, eos::chain::message_validate_exception,    \
      3040000 + 100 * operation::tag<op_name##_operation>::value,              \
      #op_name "_operation validation exception")                              \
  FC_DECLARE_DERIVED_EXCEPTION(                                                \
      op_name##_evaluate_exception, eos::chain::message_evaluate_exception,    \
...
#define EOS_DECLARE_OP_VALIDATE_EXCEPTION(exc_name, op_name, seqnum, msg)      \
  FC_DECLARE_DERIVED_EXCEPTION(                                                \
      op_name##_##exc_name, eos::chain::op_name##_validate_exception,          \
      3040000 + 100 * operation::tag<op_name##_operation>::value + seqnum,     \
      msg)

#define EOS_DECLARE_OP_EVALUATE_EXCEPTION(exc_name, op_name, seqnum, msg)      \
  FC_DECLARE_DERIVED_EXCEPTION(                                                \
      op_name##_##exc_name, eos::chain::op_name##_evaluate_exception,          \
      3050000 + 100 * operation::tag<op_name##_operation>::value + seqnum,     \
      msg)
