...
namespace eosio { namespace chain { namespace webassembly {
   ...
   void interface::assert_recover_key( const fc::sha256& digest,
                                       ...
                                       legacy_array_ptr<char> pub, uint32_t publen ) const {
   ...
   void interface::assert_sha256(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha256& hash_val) const {
      auto result = encode<fc::sha256::encoder>( context, data, datalen );
      EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
   }

   void interface::assert_sha1(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha1& hash_val) const {
      auto result = encode<fc::sha1::encoder>( context, data, datalen );
      EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
   }

   void interface::assert_sha512(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha512& hash_val) const {
      auto result = encode<fc::sha512::encoder>( context, data, datalen );
      EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
   }

   void interface::assert_ripemd160(legacy_array_ptr<char> data, uint32_t datalen, const fc::ripemd160& hash_val) const {
      auto result = encode<fc::ripemd160::encoder>( context, data, datalen );
      EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
   }

   void interface::sha1(legacy_array_ptr<char> data, uint32_t datalen, fc::sha1& hash_val) const {
      hash_val = encode<fc::sha1::encoder>( context, data, datalen );
   }

   void interface::sha256(legacy_array_ptr<char> data, uint32_t datalen, fc::sha256& hash_val) const {
      hash_val = encode<fc::sha256::encoder>( context, data, datalen );
   }

   void interface::sha512(legacy_array_ptr<char> data, uint32_t datalen, fc::sha512& hash_val) const {
      hash_val = encode<fc::sha512::encoder>( context, data, datalen );
   }

   void interface::ripemd160(legacy_array_ptr<char> data, uint32_t datalen, fc::ripemd160& hash_val) const {
      hash_val = encode<fc::ripemd160::encoder>( context, data, datalen );
   }
