...
namespace eosio { namespace chain { namespace webassembly {
   ...
   // float binops
   float interface::_eosio_f32_add( float a, float b ) {
      float32_t r = ::f32_add( to_softfloat32(a), to_softfloat32(b) );
      float ret;
      memcpy((char*)ret, (char*)r, sizeof(ret));
      return ret;
   }
   float interface::_eosio_f32_sub( float a, float b ) {
      float32_t r = ::f32_sub( to_softfloat32(a), to_softfloat32(b) );
      float ret;
      memcpy((char*)ret, (char*)r, sizeof(ret));
      return ret;
   }
   float interface::_eosio_f32_div( float a, float b ) {
      float32_t r = ::f32_div( to_softfloat32(a), to_softfloat32(b) );
      float ret;
      memcpy((char*)ret, (char*)r, sizeof(ret));
      return ret;
   }
   float interface::_eosio_f32_mul( float a, float b ) {
      float32_t r = ::f32_mul( to_softfloat32(a), to_softfloat32(b) );
      float ret;
      memcpy((char*)ret, (char*)r, sizeof(ret));
      return ret;
   }
   float interface::_eosio_f32_min( float af, float bf ) {
   ...
   float interface::_eosio_f32_max( float af, float bf ) {
      float32_t a = to_softfloat32(af);
      float32_t b = to_softfloat32(bf);
      if (is_nan(a)) {
         return af;
   ...
   float interface::_eosio_f32_copysign( float af, float bf ) {
      float32_t a = to_softfloat32(af);
      float32_t b = to_softfloat32(bf);
   ...
   // float unops
   float interface::_eosio_f32_abs( float af ) {
      float32_t a = to_softfloat32(af);
      a.v &= ~(1 << 31);
      return from_softfloat32(a);
   }
   float interface::_eosio_f32_neg( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   float interface::_eosio_f32_floor( float af ) {
      float32_t a = to_softfloat32(af);
      int e = (int)(a.v >> 23 & 0xFF) - 0X7F;
      uint32_t m;
      if (e >= 23)
   ...
   float interface::_eosio_f32_trunc( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   float interface::_eosio_f32_nearest( float af ) {
      float32_t a = to_softfloat32(af);
      int e = a.v>>23 & 0xff;
      int s = a.v>>31;
      float32_t y;
   ...
   // float relops
   bool interface::_eosio_f32_eq( float a, float b ) {  return ::f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
   bool interface::_eosio_f32_ne( float a, float b ) { return !::f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
   bool interface::_eosio_f32_lt( float a, float b ) { return ::f32_lt( to_softfloat32(a), to_softfloat32(b) ); }
   bool interface::_eosio_f32_le( float a, float b ) { return ::f32_le( to_softfloat32(a), to_softfloat32(b) ); }
   bool interface::_eosio_f32_gt( float af, float bf ) {
      float32_t a = to_softfloat32(af);
      float32_t b = to_softfloat32(bf);
      if (is_nan(a))
         return false;
   ...
   bool interface::_eosio_f32_ge( float af, float bf ) {
      float32_t a = to_softfloat32(af);
      float32_t b = to_softfloat32(bf);
      if (is_nan(a))
         return false;
   ...
   // double binops
   double interface::_eosio_f64_add( double a, double b ) {
      float64_t ret = ::f64_add( to_softfloat64(a), to_softfloat64(b) );
      return from_softfloat64(ret);
   }
   double interface::_eosio_f64_sub( double a, double b ) {
      float64_t ret = ::f64_sub( to_softfloat64(a), to_softfloat64(b) );
      return from_softfloat64(ret);
   }
   double interface::_eosio_f64_div( double a, double b ) {
      float64_t ret = ::f64_div( to_softfloat64(a), to_softfloat64(b) );
      return from_softfloat64(ret);
   }
   double interface::_eosio_f64_mul( double a, double b ) {
      float64_t ret = ::f64_mul( to_softfloat64(a), to_softfloat64(b) );
      return from_softfloat64(ret);
   }
   double interface::_eosio_f64_min( double af, double bf ) {
   ...
   double interface::_eosio_f64_max( double af, double bf ) {
      float64_t a = to_softfloat64(af);
      float64_t b = to_softfloat64(bf);
      if (is_nan(a))
         return af;
   ...
   double interface::_eosio_f64_copysign( double af, double bf ) {
      float64_t a = to_softfloat64(af);
      float64_t b = to_softfloat64(bf);
   ...
   // double unops
   double interface::_eosio_f64_abs( double af ) {
      float64_t a = to_softfloat64(af);
      a.v &= ~(uint64_t(1) << 63);
      return from_softfloat64(a);
   }
   double interface::_eosio_f64_neg( double af ) {
      float64_t a = to_softfloat64(af);
   ...
   double interface::_eosio_f64_sqrt( double a ) {
      float64_t ret = ::f64_sqrt( to_softfloat64(a) );
      return from_softfloat64(ret);
   }
   // ceil, floor, trunc and nearest are lifted from libc
   double interface::_eosio_f64_ceil( double af ) {
      float64_t a = to_softfloat64( af );
      float64_t ret;
      int e = a.v >> 52 & 0x7ff;
      float64_t y;
   ...
   double interface::_eosio_f64_floor( double af ) {
      float64_t a = to_softfloat64( af );
      float64_t ret;
      int e = a.v >> 52 & 0x7FF;
      float64_t y;
   ...
   double interface::_eosio_f64_trunc( double af ) {
      float64_t a = to_softfloat64( af );
   ...
   double inteface::_eosio_f64_nearest( double af ) {
      float64_t a = to_softfloat64( af );
      int e = (a.v >> 52 & 0x7FF);
      int s = a.v >> 63;
      float64_t y;
   ...
   // double relops
   bool inteface::_eosio_f64_eq( double a, double b ) { return ::f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
   bool inteface::_eosio_f64_ne( double a, double b ) { return !::f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
   bool inteface::_eosio_f64_lt( double a, double b ) { return ::f64_lt( to_softfloat64(a), to_softfloat64(b) ); }
   bool inteface::_eosio_f64_le( double a, double b ) { return ::f64_le( to_softfloat64(a), to_softfloat64(b) ); }
   bool inteface::_eosio_f64_gt( double af, double bf ) {
      float64_t a = to_softfloat64(af);
      float64_t b = to_softfloat64(bf);
      if (is_nan(a))
         return false;
   ...
   bool interface::_eosio_f64_ge( double af, double bf ) {
      float64_t a = to_softfloat64(af);
      float64_t b = to_softfloat64(bf);
      if (is_nan(a))
         return false;
   ...
   double interface::_eosio_f32_promote( float a ) {
      return from_softfloat64(f32_to_f64( to_softfloat32(a)) );
   }
   float interface::_eosio_f64_demote( double a ) {
      return from_softfloat32(f64_to_f32( to_softfloat64(a)) );
   }
   int32_t interface::_eosio_f32_trunc_i32s( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   int32_t interface::_eosio_f64_trunc_i32s( double af ) {
      float64_t a = to_softfloat64(af);
   ...
   uint32_t interface::_eosio_f32_trunc_i32u( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   uint32_t interface::_eosio_f64_trunc_i32u( double af ) {
      float64_t a = to_softfloat64(af);
   ...
   int64_t interface::_eosio_f32_trunc_i64s( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   int64_t interface::_eosio_f64_trunc_i64s( double af ) {
      float64_t a = to_softfloat64(af);
   ...
   uint64_t interface::_eosio_f32_trunc_i64u( float af ) {
      float32_t a = to_softfloat32(af);
   ...
   uint64_t interface::_eosio_f64_trunc_i64u( double af ) {
      float64_t a = to_softfloat64(af);
   ...
   float interface::_eosio_i32_to_f32( int32_t a )  {
      return from_softfloat32(i32_to_f32( a ));
   }
   float interface::_eosio_i64_to_f32( int64_t a ) {
      return from_softfloat32(i64_to_f32( a ));
   }
   float interface::_eosio_ui32_to_f32( uint32_t a ) {
      return from_softfloat32(ui32_to_f32( a ));
   }
   float interface::_eosio_ui64_to_f32( uint64_t a ) {
      return from_softfloat32(ui64_to_f32( a ));
   }
   double interface::_eosio_i32_to_f64( int32_t a ) {
      return from_softfloat64(i32_to_f64( a ));
   }
   double interface::_eosio_i64_to_f64( int64_t a ) {
      return from_softfloat64(i64_to_f64( a ));
   }
   double interface::_eosio_ui32_to_f64( uint32_t a ) {
      return from_softfloat64(ui32_to_f64( a ));
   }
   double interface::_eosio_ui64_to_f64( uint64_t a ) {
