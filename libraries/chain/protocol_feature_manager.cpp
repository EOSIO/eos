...
Removes the restriction on apifiny::linkauth for non-native actions named one of the five special action names:
...
Forward apifiny::setcode actions to the WebAssembly code deployed on the apifiny account.
*/
            {}
         } )
