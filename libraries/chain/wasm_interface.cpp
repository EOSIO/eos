...
class context_free_api : public context_aware_api {
   public:
      ...
      int get_context_free_data( uint32_t index, legacy_array_ptr<char> buffer, uint32_t buffer_size )const {
...
class privileged_api : public context_aware_api {
   public:
      ...
      int64_t set_proposed_producers( legacy_array_ptr<char> packed_producer_schedule, uint32_t datalen ) {
      ...
      int64_t set_proposed_producers_ex( uint64_t packed_producer_format, legacy_array_ptr<char> packed_producer_schedule, uint32_t datalen ) {
      ...
      uint32_t get_blockchain_parameters_packed( legacy_array_ptr<char> packed_blockchain_parameters, uint32_t buffer_size) {
      ...
      void set_blockchain_parameters_packed( legacy_array_ptr<char> packed_blockchain_parameters, uint32_t datalen) {
...
class producer_api : public context_aware_api {
   public:
      ...
      int get_active_producers(legacy_array_ptr<chain::account_name> producers, uint32_t buffer_size) {
...
class crypto_api : public context_aware_api {
   public:
      ...
      void assert_sha256(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha256& hash_val) {
         auto result = encode<fc::sha256::encoder>( data, datalen );
         EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
      }

      void assert_sha1(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha1& hash_val) {
         auto result = encode<fc::sha1::encoder>( data, datalen );
         EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
      }

      void assert_sha512(legacy_array_ptr<char> data, uint32_t datalen, const fc::sha512& hash_val) {
         auto result = encode<fc::sha512::encoder>( data, datalen );
         EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
      }

      void assert_ripemd160(legacy_array_ptr<char> data, uint32_t datalen, const fc::ripemd160& hash_val) {
         auto result = encode<fc::ripemd160::encoder>( data, datalen );
         EOS_ASSERT( result == hash_val, crypto_api_exception, "hash mismatch" );
      }

      void sha1(legacy_array_ptr<char> data, uint32_t datalen, fc::sha1& hash_val) {
         hash_val = encode<fc::sha1::encoder>( data, datalen );
      }

      void sha256(legacy_array_ptr<char> data, uint32_t datalen, fc::sha256& hash_val) {
         hash_val = encode<fc::sha256::encoder>( data, datalen );
      }

      void sha512(legacy_array_ptr<char> data, uint32_t datalen, fc::sha512& hash_val) {
         hash_val = encode<fc::sha512::encoder>( data, datalen );
      }

      void ripemd160(legacy_array_ptr<char> data, uint32_t datalen, fc::ripemd160& hash_val) {
...
class permission_api : public context_aware_api {
   public:
      ...
      bool check_transaction_authorization( legacy_array_ptr<char> trx_data,     uint32_t trx_size,
...
class action_api : public context_aware_api {
   ...
   action_api( apply_context& ctx )
      ...
      int read_action_data(legacy_array_ptr<char> memory, uint32_t buffer_size) {
      ...
      void set_action_return_value( legacy_array_ptr<char> packed_blob, uint32_t datalen ) {
...
class console_api : public context_aware_api {
   public:
      ...
      void prints_l(legacy_array_ptr<const char> str, uint32_t str_len ) {
         if ( !ignore ) {
...
#pragma GCC diagnostic pop
      ...
      void printhex(legacy_array_ptr<const char> data, uint32_t data_len ) {
         if ( !ignore ) {
...
#define DB_API_METHOD_WRAPPERS_ARRAY_SECONDARY(IDX, ARR_SIZE, ARR_ELEMENT_TYPE)\
      int db_##IDX##_store( uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, legacy_array_ptr<const ARR_ELEMENT_TYPE> data, uint32_t data_len) {\
      ...
      void db_##IDX##_update( int iterator, uint64_t payer, legacy_array_ptr<const ARR_ELEMENT_TYPE> data, uint32_t data_len ) {\
         EOS_ASSERT( data_len == ARR_SIZE,\
                    db_api_exception,\
                    "invalid size of secondary key array for " #IDX ": given ${given} bytes but expected ${expected} bytes",\
                    ("given",data_len)("expected",ARR_SIZE) );\
      ...
      int db_##IDX##_find_secondary( uint64_t code, uint64_t scope, uint64_t table, legacy_array_ptr<const ARR_ELEMENT_TYPE> data, uint32_t data_len, uint64_t& primary ) {\
         EOS_ASSERT( data_len == ARR_SIZE,\
                    db_api_exception,\
                    "invalid size of secondary key array for " #IDX ": given ${given} bytes but expected ${expected} bytes",\
                    ("given",data_len)("expected",ARR_SIZE) );\
      ...
      int db_##IDX##_find_primary( uint64_t code, uint64_t scope, uint64_t table, legacy_array_ptr<ARR_ELEMENT_TYPE> data, uint32_t data_len, uint64_t primary ) {\
         EOS_ASSERT( data_len == ARR_SIZE,\
                    db_api_exception,\
                    "invalid size of secondary key array for " #IDX ": given ${given} bytes but expected ${expected} bytes",\
                    ("given",data_len)("expected",ARR_SIZE) );\
      ...
      int db_##IDX##_lowerbound( uint64_t code, uint64_t scope, uint64_t table, legacy_array_ptr<ARR_ELEMENT_TYPE> data, uint32_t data_len, uint64_t& primary ) {\
         EOS_ASSERT( data_len == ARR_SIZE,\
                    db_api_exception,\
                    "invalid size of secondary key array for " #IDX ": given ${given} bytes but expected ${expected} bytes",\
                    ("given",data_len)("expected",ARR_SIZE) );\
      ...
      int db_##IDX##_upperbound( uint64_t code, uint64_t scope, uint64_t table, legacy_array_ptr<ARR_ELEMENT_TYPE> data, uint32_t data_len, uint64_t& primary ) {\
         EOS_ASSERT( data_len == ARR_SIZE,\
                    db_api_exception,\
                    "invalid size of secondary key array for " #IDX ": given ${given} bytes but expected ${expected} bytes",\
                    ("given",data_len)("expected",ARR_SIZE) );\
...
class database_api : public context_aware_api {
   public:
      ...
      int db_store_i64( uint64_t scope, uint64_t table, uint64_t payer, uint64_t id, legacy_array_ptr<const char> buffer, uint32_t buffer_size ) {
         return context.db_store_i64( name(scope), name(table), account_name(payer), id, buffer, buffer_size );
      }
      void db_update_i64( int itr, uint64_t payer, legacy_array_ptr<const char> buffer, uint32_t buffer_size ) {
         context.db_update_i64( itr, account_name(payer), buffer, buffer_size );
      }
      void db_remove_i64( int itr ) {
         context.db_remove_i64( itr );
      }
      int db_get_i64( int itr, legacy_array_ptr<char> buffer, uint32_t buffer_size ) {
...
class memory_api : public context_aware_api {
   public:
      ...
      char* memcpy( legacy_array_ptr<char> dest, legacy_array_ptr<const char> src, uint32_t length) {
      ...
      char* memmove( legacy_array_ptr<char> dest, legacy_array_ptr<const char> src, uint32_t length) {
         return (char *)::memmove(dest, src, length);
      }

      int memcmp( legacy_array_ptr<const char> dest, legacy_array_ptr<const char> src, uint32_t length) {
      ...
      char* memset( legacy_array_ptr<char> dest, int value, uint32_t length ) {
...
class transaction_api : public context_aware_api {
   public:
      ...
      void send_inline( legacy_array_ptr<char> data, uint32_t data_len ) {
      ...
      void send_context_free_inline( legacy_array_ptr<char> data, uint32_t data_len ) {
         //TODO: Why is this limit even needed? And why is it not consistently checked on actions in input or deferred transactions
         EOS_ASSERT( data_len < context.control.get_global_properties().configuration.max_inline_action_size, inline_action_too_big,
                   "inline action too big" );
      ...
      void send_deferred( const uint128_t& sender_id, account_name payer, legacy_array_ptr<char> data, uint32_t data_len, uint32_t replace_existing) {
         transaction trx;
...
class context_free_transaction_api : public context_aware_api {
   public:
      ...
      int read_transaction( legacy_array_ptr<char> data, uint32_t buffer_size ) {
      ...
      int get_action( uint32_t type, uint32_t index, legacy_array_ptr<char> buffer, uint32_t buffer_size )const {
