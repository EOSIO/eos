...
storage_usage_trace db_context::add_table_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table", "add", "create_table");
}

storage_usage_trace db_context::rem_table_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table", "remove", "remove_table");
}

storage_usage_trace db_context::row_add_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table_row", "add", "primary_index_add");
}

storage_usage_trace db_context::row_update_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table_row", "update", "primary_index_update");
}

storage_usage_trace db_context::row_update_add_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table_row", "add", "primary_index_update_add_new_payer");
}

storage_usage_trace db_context::row_update_rem_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table_row", "remove", "primary_index_update_remove_old_payer");
}

storage_usage_trace db_context::row_rem_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "table_row", "remove", "primary_index_remove");
}

storage_usage_trace db_context::secondary_add_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "secondary_index", "add", "secondary_index_add");
}

storage_usage_trace db_context::secondary_rem_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "secondary_index", "remove", "secondary_index_remove");
}

storage_usage_trace db_context::secondary_update_add_trace(uint32_t action_id, const std::string& event_id) {
   return storage_usage_trace(action_id, event_id.c_str(), "secondary_index", "add", "secondary_index_update_add_new_payer");
}

storage_usage_trace db_context::secondary_update_rem_trace(uint32_t action_id, const std::string& event_id) {
