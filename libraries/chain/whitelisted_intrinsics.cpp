...
namespace eosio { namespace chain {
   ...
   bool find_intrinsic_helper( uint64_t h, const std::string_view name, Iterator& itr, const Iterator& end ) {
   ...
   find_intrinsic( whitelisted_intrinsics_type& whitelisted_intrinsics, uint64_t h, const std::string_view name )
   {
   ...
   find_intrinsic( const whitelisted_intrinsics_type& whitelisted_intrinsics, uint64_t h, const std::string_view name )
   {
      auto itr = whitelisted_intrinsics.lower_bound( h );
      const auto end = whitelisted_intrinsics.end();
