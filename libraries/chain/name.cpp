...
namespace fc {
  void to_variant(const apifiny::chain::name& c, fc::variant& v) { v = c.to_string(); }
  void from_variant(const fc::variant& v, apifiny::chain::name& check) { check.set( v.get_string() ); }
} // fc
