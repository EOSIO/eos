 ...
 * @return The properly sorted RoundChanges expressing the difference between a
 * and b
 *
 * Calculates the difference between two rounds of producers, returning a @ref
 * RoundChanges object. The returned
...
enum object_type {
  ...
  account_transaction_history_object_type, ///< Defined by
  ...
  OBJECT_TYPE_COUNT ///< Sentry value which contains the number of different
                    ///object types
};
...
namespace fc {
void to_variant(const eos::chain::shared_vector<eos::types::Field> &c,
                fc::variant &v);
void from_variant(const fc::variant &v,
                  eos::chain::shared_vector<eos::types::Field> &fields);
...
FC_REFLECT_ENUM(
    eos::chain::object_type,
    (null_object_type)(account_object_type)(permission_object_type)(
        permission_link_object_type)(action_code_object_type)(
        key_value_object_type)(key128x128_value_object_type)(
        action_permission_object_type)(global_property_object_type)(
        dynamic_global_property_object_type)(block_summary_object_type)(
        transaction_object_type)(generated_transaction_object_type)(
        ...
        transaction_history_object_type)(public_key_history_object_type)(
        balance_object_type)(staked_balance_object_type)(
        producer_votes_object_type)(producer_schedule_object_type)(
        proxy_vote_object_type)(key64x64x64_value_object_type)(
        keystr_value_object_type)(OBJECT_TYPE_COUNT))
