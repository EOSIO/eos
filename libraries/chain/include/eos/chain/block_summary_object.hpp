 ...
 */
class block_summary_object : public chainbase::object<block_summary_object_type,
...
using block_summary_multi_index = chainbase::shared_multi_index_container<
    ...
    indexed_by<ordered_unique<
        tag<by_id>, BOOST_MULTI_INDEX_MEMBER(block_summary_object,
                                             block_summary_object::id_type, id)>
               //      ordered_unique<tag<by_block_id>,
               //      BOOST_MULTI_INDEX_MEMBER(block_summary_object,
               //      block_id_type, block_id)>
               >>;
}
}

CHAINBASE_SET_INDEX_TYPE(eos::chain::block_summary_object,
                         eos::chain::block_summary_multi_index)
