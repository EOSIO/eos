...
FC_REFLECT( apifiny::chain::legacy::producer_key, (producer_name)(block_signing_key) )
FC_REFLECT( apifiny::chain::legacy::producer_schedule_type, (version)(producers) )
FC_REFLECT( apifiny::chain::block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( apifiny::chain::producer_authority, (producer_name)(authority) )
FC_REFLECT( apifiny::chain::producer_authority_schedule, (version)(producers) )
FC_REFLECT_DERIVED( apifiny::chain::producer_schedule_change_extension, (apifiny::chain::producer_authority_schedule), )

FC_REFLECT( apifiny::chain::shared_block_signing_authority_v0, (threshold)(keys))
FC_REFLECT( apifiny::chain::shared_producer_authority, (producer_name)(authority) )
FC_REFLECT( apifiny::chain::shared_producer_authority_schedule, (version)(producers) )
