...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::permission_link_object, apifiny::chain::permission_link_index)

FC_REFLECT(apifiny::chain::permission_link_object, (account)(code)(message_type)(required_permission))
