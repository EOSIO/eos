...
#include <apifiny/chain/action_receipt.hpp>
...
FC_REFLECT( apifiny::chain::account_delta,
            (account)(delta) )

FC_REFLECT( apifiny::chain::action_trace,
...
FC_REFLECT( apifiny::chain::transaction_trace, (id)(block_num)(block_time)(producer_block_id)
