#pragma once
#include <apifiny/chain/block_header.hpp>
...
FC_REFLECT_ENUM( apifiny::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(apifiny::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(apifiny::chain::transaction_receipt, (apifiny::chain::transaction_receipt_header), (trx) )
FC_REFLECT(apifiny::chain::additional_block_signatures_extension, (signatures));
FC_REFLECT_DERIVED(apifiny::chain::signed_block, (apifiny::chain::signed_block_header), (transactions)(block_extensions) )
