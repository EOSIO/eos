...
#include <apifiny/chain/abi_def.hpp>
...
namespace apifiny { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const apifiny::chain::abi_def& a ) {
      ...
      apifiny::chain::abi_def get_abi()const {
         apifiny::chain::abi_def a;
         APIFINY_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::account_object, apifiny::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::account_metadata_object, apifiny::chain::account_metadata_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::account_ram_correction_object, apifiny::chain::account_ram_correction_index)


FC_REFLECT(apifiny::chain::account_object, (name)(creation_date)(abi))
FC_REFLECT(apifiny::chain::account_metadata_object, (name)(recv_sequence)(auth_sequence)(code_sequence)(abi_sequence)
                                                  (code_hash)(last_code_update)(flags)(vm_type)(vm_version))
FC_REFLECT(apifiny::chain::account_ram_correction_object, (name)(ram_correction))
