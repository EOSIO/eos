...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::permission_object, apifiny::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::permission_usage_object, apifiny::chain::permission_usage_index)

FC_REFLECT(apifiny::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
FC_REFLECT(apifiny::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

FC_REFLECT(apifiny::chain::permission_usage_object, (last_used))
