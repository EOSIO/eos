...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::database_header_object, apifiny::chain::database_header_multi_index)

FC_REFLECT( apifiny::chain::database_header_object, (version) )
