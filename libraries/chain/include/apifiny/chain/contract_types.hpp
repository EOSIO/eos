...
using action_name    = apifiny::chain::action_name;
...
FC_REFLECT( apifiny::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( apifiny::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( apifiny::chain::setabi                           , (account)(abi) )
FC_REFLECT( apifiny::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( apifiny::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( apifiny::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( apifiny::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( apifiny::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( apifiny::chain::onerror                          , (sender_id)(sent_trx) )
