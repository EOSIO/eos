...
namespace apifiny { namespace chain { namespace config {
...
const static name system_account_name    { N(apifiny) };
const static name null_account_name      { N(apifiny.null) };
const static name producers_account_name { N(apifiny.prods) };
...
const static name apifiny_auth_scope       { N(apifiny.auth) };
const static name apifiny_all_scope        { N(apifiny.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name apifiny_any_name  { N(apifiny.any) };
const static name apifiny_code_name { N(apifiny.code) };
...
const static apifiny::chain::wasm_interface::vm_type default_wasm_runtime = apifiny::chain::wasm_interface::vm_type::wabt;
