...
namespace apifiny { namespace chain {
   ...
   class controller;
   namespace apifinyvmoc { struct config; }
   ...
   class wasm_interface {
      public:
         ...
         wasm_interface(vm_type vm, bool apifinyvmoc_tierup, const chainbase::database& d, const boost::filesystem::path data_dir, const apifinyvmoc::config& apifinyvmoc_config);
         ~wasm_interface();
      ...
      private:
         ...
         friend class apifiny::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( apifiny::chain::wasm_interface::vm_type, (wabt)(apifiny_vm)(apifiny_vm_jit)(apifiny_vm_oc) )
