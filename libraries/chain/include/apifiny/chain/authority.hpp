...
FC_REFLECT(apifiny::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(apifiny::chain::key_weight, (key)(weight) )
FC_REFLECT(apifiny::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(apifiny::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(apifiny::chain::shared_key_weight, (key)(weight) )
FC_REFLECT(apifiny::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(apifiny::chain::shared_public_key, (pubkey))
