...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::block_summary_object, apifiny::chain::block_summary_multi_index)

FC_REFLECT( apifiny::chain::block_summary_object, (block_id) )
