...
#define APIFINY_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
      ...
      throw;\
   } catch (apifiny::chain::chain_exception& e) { \
...
namespace apifiny { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( apifiny_assert_message_exception, action_validate_exception,
                                    3050003, "apifiny_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( apifiny_assert_code_exception, action_validate_exception,
                                    3050004, "apifiny_assert_code assertion failure" )
      ...
      FC_DECLARE_DERIVED_EXCEPTION( restricted_error_code_exception, action_validate_exception,
                                    3050011, "apifiny_assert_code assertion failure uses restricted error code value" )
