...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::transaction_object, apifiny::chain::transaction_multi_index)

FC_REFLECT(apifiny::chain::transaction_object, (expiration)(trx_id))
