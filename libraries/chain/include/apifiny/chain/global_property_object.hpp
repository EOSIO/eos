...
#include <apifiny/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::global_property_object, apifiny::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::dynamic_global_property_object,
                         apifiny::chain::dynamic_global_property_multi_index)

FC_REFLECT(apifiny::chain::global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(apifiny::chain::legacy::snapshot_global_property_object_v2,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)
          )

FC_REFLECT(apifiny::chain::snapshot_global_property_object,
            (proposed_schedule_block_num)(proposed_schedule)(configuration)(chain_id)
          )

FC_REFLECT(apifiny::chain::dynamic_global_property_object,
