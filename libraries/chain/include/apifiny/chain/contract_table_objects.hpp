...
#include <apifiny/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::table_id_object, apifiny::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::key_value_object, apifiny::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(apifiny::chain::index64_object, apifiny::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::index128_object, apifiny::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::index256_object, apifiny::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::index_double_object, apifiny::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(apifiny::chain::index_long_double_object, apifiny::chain::index_long_double_index)

FC_REFLECT(apifiny::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(apifiny::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(apifiny::chain::index64_object)
REFLECT_SECONDARY(apifiny::chain::index128_object)
REFLECT_SECONDARY(apifiny::chain::index256_object)
REFLECT_SECONDARY(apifiny::chain::index_double_object)
REFLECT_SECONDARY(apifiny::chain::index_long_double_object)
