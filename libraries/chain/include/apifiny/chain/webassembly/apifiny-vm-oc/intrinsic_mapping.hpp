...
constexpr auto intrinsic_table = boost::hana::make_tuple(
   "apifinyvmoc_internal.unreachable"_s,
   "apifinyvmoc_internal.grow_memory"_s,
   "apifinyvmoc_internal.div0_or_overflow"_s,
   ...
   "env.get_sender"_s,
   "env.abort"_s,
   "env.apifiny_assert"_s,
   "env.apifiny_assert_message"_s,
   "env.apifiny_assert_code"_s,
   "env.apifiny_exit"_s,
   ...
   "env.memcmp"_s,
   "env.memset"_s,
   "apifiny_injection._apifiny_f32_add"_s,
   "apifiny_injection._apifiny_f32_sub"_s,
   "apifiny_injection._apifiny_f32_mul"_s,
   "apifiny_injection._apifiny_f32_div"_s,
   "apifiny_injection._apifiny_f32_min"_s,
   "apifiny_injection._apifiny_f32_max"_s,
   "apifiny_injection._apifiny_f32_copysign"_s,
   "apifiny_injection._apifiny_f32_abs"_s,
   "apifiny_injection._apifiny_f32_neg"_s,
   "apifiny_injection._apifiny_f32_sqrt"_s,
   "apifiny_injection._apifiny_f32_ceil"_s,
   "apifiny_injection._apifiny_f32_floor"_s,
   "apifiny_injection._apifiny_f32_trunc"_s,
   "apifiny_injection._apifiny_f32_nearest"_s,
   "apifiny_injection._apifiny_f32_eq"_s,
   "apifiny_injection._apifiny_f32_ne"_s,
   "apifiny_injection._apifiny_f32_lt"_s,
   "apifiny_injection._apifiny_f32_le"_s,
   "apifiny_injection._apifiny_f32_gt"_s,
   "apifiny_injection._apifiny_f32_ge"_s,
   "apifiny_injection._apifiny_f64_add"_s,
   "apifiny_injection._apifiny_f64_sub"_s,
   "apifiny_injection._apifiny_f64_mul"_s,
   "apifiny_injection._apifiny_f64_div"_s,
   "apifiny_injection._apifiny_f64_min"_s,
   "apifiny_injection._apifiny_f64_max"_s,
   "apifiny_injection._apifiny_f64_copysign"_s,
   "apifiny_injection._apifiny_f64_abs"_s,
   "apifiny_injection._apifiny_f64_neg"_s,
   "apifiny_injection._apifiny_f64_sqrt"_s,
   "apifiny_injection._apifiny_f64_ceil"_s,
   "apifiny_injection._apifiny_f64_floor"_s,
   "apifiny_injection._apifiny_f64_trunc"_s,
   "apifiny_injection._apifiny_f64_nearest"_s,
   "apifiny_injection._apifiny_f64_eq"_s,
   "apifiny_injection._apifiny_f64_ne"_s,
   "apifiny_injection._apifiny_f64_lt"_s,
   "apifiny_injection._apifiny_f64_le"_s,
   "apifiny_injection._apifiny_f64_gt"_s,
   "apifiny_injection._apifiny_f64_ge"_s,
   "apifiny_injection._apifiny_f32_promote"_s,
   "apifiny_injection._apifiny_f64_demote"_s,
   "apifiny_injection._apifiny_f32_trunc_i32s"_s,
   "apifiny_injection._apifiny_f64_trunc_i32s"_s,
   "apifiny_injection._apifiny_f32_trunc_i32u"_s,
   "apifiny_injection._apifiny_f64_trunc_i32u"_s,
   "apifiny_injection._apifiny_f32_trunc_i64s"_s,
   "apifiny_injection._apifiny_f64_trunc_i64s"_s,
   "apifiny_injection._apifiny_f32_trunc_i64u"_s,
   "apifiny_injection._apifiny_f64_trunc_i64u"_s,
   "apifiny_injection._apifiny_i32_to_f32"_s,
   "apifiny_injection._apifiny_i64_to_f32"_s,
   "apifiny_injection._apifiny_ui32_to_f32"_s,
   "apifiny_injection._apifiny_ui64_to_f32"_s,
   "apifiny_injection._apifiny_i32_to_f64"_s,
   "apifiny_injection._apifiny_i64_to_f64"_s,
   "apifiny_injection._apifiny_ui32_to_f64"_s,
   "apifiny_injection._apifiny_ui64_to_f64"_s,
