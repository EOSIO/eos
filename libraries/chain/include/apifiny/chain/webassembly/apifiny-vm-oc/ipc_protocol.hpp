...
struct code_tuple {
   apifiny::chain::digest_type code_id;
   uint8_t vm_version;
...
using apifinyvmoc_message = fc::static_variant<initialize_message,
...
FC_REFLECT(apifiny::chain::apifinyvmoc::initialize_message, )
FC_REFLECT(apifiny::chain::apifinyvmoc::initalize_response_message, (error_message))
FC_REFLECT(apifiny::chain::apifinyvmoc::code_tuple, (code_id)(vm_version))
FC_REFLECT(apifiny::chain::apifinyvmoc::compile_wasm_message, (code))
FC_REFLECT(apifiny::chain::apifinyvmoc::evict_wasms_message, (codes))
FC_REFLECT(apifiny::chain::apifinyvmoc::code_compilation_result_message, (start)(apply_offset)(starting_memory_pages)(initdata_prologue_size))
FC_REFLECT(apifiny::chain::apifinyvmoc::compilation_result_unknownfailure, )
FC_REFLECT(apifiny::chain::apifinyvmoc::compilation_result_toofull, )
FC_REFLECT(apifiny::chain::apifinyvmoc::wasm_compilation_result_message, (code)(result)(cache_free_bytes))