...
FC_REFLECT(enumivo::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(enumivo::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(enumivo::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
