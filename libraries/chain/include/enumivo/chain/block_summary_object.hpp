...
CHAINBASE_SET_INDEX_TYPE(enumivo::chain::block_summary_object, enumivo::chain::block_summary_multi_index)

FC_REFLECT( enumivo::chain::block_summary_object, (block_id) )
