...
namespace eosio { namespace chain {
   ...
   template<>
   struct config::billable_size<permission_object> {
      static const uint64_t  overhead = 6 * config::overhead_per_row_per_index_ram_bytes; ///< 6 indices 2x internal ID, parent, owner, name, name_usage
