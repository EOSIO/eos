...
namespace eosio { namespace chain {
   ...
   class controller {
      public:
         ...
         std::future<std::exception_ptr> finalize_block(block_state_ptr& bsp, signer_callback_type&& signer_callback,
                                                        std::function<void(std::exception_ptr ptr)>&& continuation =
                                                            std::function<void(std::exception_ptr ptr)>());
