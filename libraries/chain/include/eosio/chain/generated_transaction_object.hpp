...
namespace eosio { namespace chain {
   ...
   template<>
   struct config::billable_size<generated_transaction_object> {
      static const uint64_t overhead = config::overhead_per_row_per_index_ram_bytes * 5;  ///< overhead for 5x indices internal-key, txid, expiration, delay, sender_id
