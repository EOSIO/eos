...
const static uint32_t   default_target_block_cpu_usage_pct          = 20 * percent_1;
...
const static uint32_t   default_min_transaction_cpu_usage           = 10; /// min trx cpu usage in microseconds (10000 TPS equiv)
