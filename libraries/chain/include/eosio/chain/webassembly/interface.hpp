...
template <typename T>
using output_proxy = eosio::vm::argument_proxy<T*, 0>;
...
class interface {
 public:
   ...
   void get_resource_limits(account_name account, legacy_ptr<int64_t, 8> ram_bytes, legacy_ptr<int64_t, 8> net_weight,
   ...
   // permission api
   bool check_transaction_authorization(legacy_span<const char>, legacy_span<const char>,
                                        legacy_span<const char>) const;
   bool check_permission_authorization(account_name, permission_name, legacy_span<const char>, legacy_span<const char>,
                                       uint64_t) const;
   ...
   int32_t db_idx_double_find_secondary(uint64_t, uint64_t, uint64_t, legacy_ptr<const float64_t>,
                                        legacy_ptr<uint64_t>);
   ...
   int32_t db_idx_long_double_find_secondary(uint64_t, uint64_t, uint64_t, legacy_ptr<const float128_t>,
                                             legacy_ptr<uint64_t>);
   int32_t db_idx_long_double_find_primary(uint64_t, uint64_t, uint64_t, legacy_ptr<float128_t>, uint64_t);
   int32_t db_idx_long_double_lowerbound(uint64_t, uint64_t, uint64_t, legacy_ptr<float128_t, 8>,
                                         legacy_ptr<uint64_t, 8>);
   int32_t db_idx_long_double_upperbound(uint64_t, uint64_t, uint64_t, legacy_ptr<float128_t, 8>,
                                         legacy_ptr<uint64_t, 8>);
   ...
   bool     kv_get(uint64_t, uint64_t, span<const char>, output_proxy<uint32_t>);
   ...
   int32_t  kv_it_next(uint32_t, output_proxy<uint32_t> found_key_size, output_proxy<uint32_t> found_value_size);
   int32_t  kv_it_prev(uint32_t, output_proxy<uint32_t> found_key_size, output_proxy<uint32_t> found_value_size);
   int32_t  kv_it_lower_bound(uint32_t, span<const char>, output_proxy<uint32_t> found_key_size, output_proxy<uint32_t> found_value_size);
   int32_t  kv_it_key(uint32_t, uint32_t, span<char>, output_proxy<uint32_t>);
   int32_t  kv_it_value(uint32_t, uint32_t, span<char> dest, output_proxy<uint32_t>);
