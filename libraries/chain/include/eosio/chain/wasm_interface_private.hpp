...
#define _REGISTER_INTRINSIC(R, CLS, METHOD)\
   {\
      ...
      std::forward_as_tuple(\
         #METHOD,\
         eosio::chain::intrinsic_function_invoker<decltype(&CLS::METHOD), &CLS::METHOD>::wasm_function_type(),\
         (void*)eosio::chain::intrinsic_function_invoker<decltype(&CLS::METHOD), &CLS::METHOD>::fn<&CLS::METHOD>()\
      )\
   },
