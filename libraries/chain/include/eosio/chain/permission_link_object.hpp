...
namespace eosio { namespace chain {
   ...
   template<>
   struct config::billable_size<permission_link_object> {
      static const uint64_t overhead = config::overhead_per_row_per_index_ram_bytes * 3; ///< 3x indices id, action, permission
