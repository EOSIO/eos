...
template <typename DB>
inline void state_history_traces_log::store(const DB& db, const chain::block_state_ptr& block_state) {
...
template <typename DB>
inline void state_history_chain_state_log::store(const DB& db, const chain::block_state_ptr& block_state) {
