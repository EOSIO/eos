 ...
 */
void assert_sha256( char* data, uint32_t length, const checksum_base* hash );
 ...
 *  This method is optimized to a NO-OP when in fast evaluation mode
 */
void assert_sha1( char* data, uint32_t length, const checksum_base* hash );
 ...
 *  This method is optimized to a NO-OP when in fast evaluation mode
 */
void assert_sha512( char* data, uint32_t length, const checksum_base* hash );
 ...
 *  This method is optimized to a NO-OP when in fast evaluation mode
 */
void assert_ripemd160( char* data, uint32_t length, const checksum_base* hash );
