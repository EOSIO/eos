...
/**
  ...
  * @param lb   Low 64 bits of the second 128 bit factor.
  * @param hb   High 64 bits of the second 128 bit factor.
  * @return 1 if a greater than b, 0 if a equal to b, -1 if a less than b, 1 if either a or b is NaN
  */
  ...
  * @param lb   Low 64 bits of the second 128 bit factor.
  * @param hb   High 64 bits of the second 128 bit factor.
  * @return 1 if a greater than b, 0 if a equal to b, -1 if a less than b, 0 if either a or b is NaN
  */
  ...
  * @param lb   Low 64 bits of the second 128 bit factor.
  * @param hb   High 64 bits of the second 128 bit factor.
  * @return 1 if either a or b is NaN, 0 otherwise
  */
