...
namespace arisensystem {
   ...
   typedef arisen::multi_index< N(namebids), name_bid,
   ...
   struct arisen_global_state : arisen::blockchain_parameters {
      ...
      RSNLIB_SERIALIZE_DERIVED( arisen_global_state, arisen::blockchain_parameters,
   ...
   struct producer_info {
      ...
      arisen::public_key     producer_key; /// a packed public key object
      bool                  is_active = true;
      std::string           url;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      RSNLIB_SERIALIZE( producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
   ...
   struct voter_info {
      ...
      time                        reserved2 = 0;
      arisen::asset                reserved3;

      uint64_t primary_key()const { return owner; }

      // explicit serialization macro is not necessary, used here only to improve compilation time
      RSNLIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(last_vote_weight)(proxied_vote_weight)(is_proxy)(reserved1)(reserved2)(reserved3) )
   };

   typedef arisen::multi_index< N(voters), voter_info>  voters_table;


   typedef arisen::multi_index< N(producers), producer_info,
   ...
   class system_contract : public native {
      ...
      public:
         ...
         void setparams( const arisen::blockchain_parameters& params );
