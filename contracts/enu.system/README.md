...
## enu.system::cfgproducer    account config
...
## enu.system::okproducer     account producer vote
...
## enu.system::setproxy       account proxy
...
## enu.system::unstake        account quantity 
...
## enu.system::withdraw account
   - this action can only be triggered by enu.system via a deferred transaction generated by unstake
   - this will generate an inline enu.token::transfer call from=enu.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## enu.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## enu.system::stakevote account amount
...
## enu.system::onblock   account blocktime blocknum
...
## enu.system::freeze producer accounts true|false 
...
## enu.system::paystandby producer
