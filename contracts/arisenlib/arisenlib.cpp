...
{
   return arisen::memory_heap.malloc(size);
}

void* calloc(size_t count, size_t size)
{
   void* ptr = arisen::memory_heap.malloc(count*size);
...
{
   return arisen::memory_heap.realloc(ptr, size);
}

void free(void* ptr)
{
   return arisen::memory_heap.free(ptr);
}
