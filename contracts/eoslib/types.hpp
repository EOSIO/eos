...
/**
 * @brief used to generate a compile time uint64_t from the base32 encoded
 * string interpretation of X
 * @ingroup types
 */
...
/**
 *  @class Name
 *  @brief wraps a uint64_t to ensure it is only passed to methods that expect a
 * Name
 *  @details wraps a uint64_t to ensure it is only passed to methods that expect
 * a Name and
 *         that no mathematical operations occur.  It also enables
 * specialization of print
