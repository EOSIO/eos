 ...
 */
inline void print(uint64_t num) { printi(num); }
 ...
 * @param Value to be printed
 */
inline void print(uint32_t num) { printi(num); }
 ...
 * @param Value to be printed
 */
inline void print(int num) { printi(num); }
 ...
 * @param Value to be printed
 */
inline void print(unsigned int num) { printi(num); }
 ...
 * @param Value to be printed
 */
inline void print(uint128 num) { printi128((uint128_t *)&num); }
 ...
 * @param Value to be printed
 */
inline void print(uint128_t num) { printi128((uint128_t *)&num); }
 ...
 */
inline void print(Name name) { printn(name.value); }
 ...
 *  print(s , unsigned_64_bit_int, unsigned_128_bit_int,
 ...
 *  @endcode
 */
template <typename T> inline iostream &operator<<(iostream &out, const T &v) {
  print(v);
  return out;
}
