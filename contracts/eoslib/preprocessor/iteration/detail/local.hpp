...
#        include <eoslib/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <eoslib/preprocessor/iteration/detail/finish.hpp>
...
#    include <eoslib/preprocessor/iteration/detail/rlocal.hpp>
# else
