...
# include <eoslib/preprocessor/punctuation/paren.hpp>
# include <eoslib/preprocessor/seq/detail/binary_transform.hpp>
#
# /* BOOST_PP_SEQ_TO_LIST */
#
# if BOOST_PP_CONFIG_FLAGS() & BOOST_PP_CONFIG_MSVC()
# include <eoslib/preprocessor/seq/size.hpp>
# include <eoslib/preprocessor/seq/detail/to_list_msvc.hpp>
