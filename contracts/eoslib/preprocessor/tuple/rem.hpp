...
# include <eoslib/preprocessor/facilities/expand.hpp>
# include <eoslib/preprocessor/facilities/overload.hpp>
# include <eoslib/preprocessor/tuple/detail/is_single_return.hpp>
#
# /* BOOST_PP_REM */
#
