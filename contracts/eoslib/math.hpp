...
/**
 * Multiply two 128 bit unsigned integers and assign the value to the first
 * parameter.
...
/**
 * Divide two 128 bit unsigned integers and assign the value to the first
 * parameter.
...
/**
 * @brief A struct that wraps uint128 integer and defines common operator
 * overloads
 */
struct uint128 {
public:
