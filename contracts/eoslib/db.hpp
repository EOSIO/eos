...
struct table {
   ...
   struct secondary_index {
       ...
       */
       static bool get( const SecondaryType& p, Record& r, uint64_t s = scope ) {
          unsigned char *ptr = (unsigned char *)&r + sizeof(PrimaryType);
          *reinterpret_cast<SecondaryType*>(ptr) = p;
          return impl::load_secondary( s, code, table_n, &r, sizeof(Record) ) == sizeof(Record);
       }
       ...
       */
       ...
       static bool lower_bound( const SecondaryType& p, Record& r, uint64_t s = scope ) {
          unsigned char *ptr = (unsigned char *)&r + sizeof(PrimaryType);
          *reinterpret_cast<SecondaryType*>(ptr) = p;
          return impl::lower_bound_secondary( s, code, table_n, &r, sizeof(Record) ) == sizeof(Record);
       }
       ...
       static bool upper_bound( const SecondaryType& p, Record& r, uint64_t s = scope ) {
          unsigned char *ptr = (unsigned char *)&r + sizeof(PrimaryType);
          *reinterpret_cast<SecondaryType*>(ptr) = p;
          return impl::upper_bound_secondary( s, code, table_n, &r, sizeof(Record) ) == sizeof(Record);
       }
    ...
    */
    ...
    static bool store( const Record& r, uint64_t s = scope ) {
       impl::store( s, table_n, &r, sizeof(r) );
       return true;
    }
    ...
    */
    static bool update( const Record& r, uint64_t s = scope ) {
       impl::update( s, table_n, &r, sizeof(r) );
       return true;
    }
