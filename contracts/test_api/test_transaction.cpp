...
void test_transaction::assert_false_error_handler(const eosio::transaction& trx) {
   auto onerror_action = eosio::get_action(1, 0);
   eosio_assert( onerror_action.authorization.at(0).actor == trx.actions.at(0).account,
