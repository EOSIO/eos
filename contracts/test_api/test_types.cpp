...
unsigned int test_types::string_to_name() {
  ...
  WASM_ASSERT(eos::string_to_name("dcba") == N(dcba),
              "eos::string_to_name(dcba)");
  WASM_ASSERT(eos::string_to_name("edcba") == N(edcba),
              "eos::string_to_name(edcba)");
  WASM_ASSERT(eos::string_to_name("fedcba") == N(fedcba),
              "eos::string_to_name(fedcba)");
  WASM_ASSERT(eos::string_to_name("gfedcba") == N(gfedcba),
              "eos::string_to_name(gfedcba)");
  WASM_ASSERT(eos::string_to_name("hgfedcba") == N(hgfedcba),
              "eos::string_to_name(hgfedcba)");
  WASM_ASSERT(eos::string_to_name("ihgfedcba") == N(ihgfedcba),
              "eos::string_to_name(ihgfedcba)");
  WASM_ASSERT(eos::string_to_name("jihgfedcba") == N(jihgfedcba),
              "eos::string_to_name(jihgfedcba)");
  WASM_ASSERT(eos::string_to_name("kjihgfedcba") == N(kjihgfedcba),
              "eos::string_to_name(kjihgfedcba)");
  WASM_ASSERT(eos::string_to_name("lkjihgfedcba") == N(lkjihgfedcba),
              "eos::string_to_name(lkjihgfedcba)");
  WASM_ASSERT(eos::string_to_name("mlkjihgfedcba") == N(mlkjihgfedcba),
              "eos::string_to_name(mlkjihgfedcba)");
  WASM_ASSERT(eos::string_to_name("mlkjihgfedcba1") == N(mlkjihgfedcba2),
              "eos::string_to_name(mlkjihgfedcba2)");
  WASM_ASSERT(eos::string_to_name("mlkjihgfedcba55") == N(mlkjihgfedcba14),
              "eos::string_to_name(mlkjihgfedcba14)");

  WASM_ASSERT(eos::string_to_name("azAA34") == N(azBB34),
              "eos::string_to_name N(azBB34)");
  WASM_ASSERT(eos::string_to_name("AZaz12Bc34") == N(AZaz12Bc34),
              "eos::string_to_name AZaz12Bc34");
  WASM_ASSERT(eos::string_to_name("AAAAAAAAAAAAAAA") ==
                  eos::string_to_name("BBBBBBBBBBBBBDDDDDFFFGG"),
              "eos::string_to_name BBBBBBBBBBBBBDDDDDFFFGG");
...
unsigned int test_types::name_class() {
  ...
  WASM_ASSERT(eos::Name(eos::string_to_name("azAA34")).value == N(azAA34),
              "eos::Name != N(azAA34)");
  WASM_ASSERT(eos::Name(eos::string_to_name("AABBCC")).value == 0,
              "eos::Name != N(0)");
  WASM_ASSERT(eos::Name(eos::string_to_name("AA11")).value == N(AA11),
              "eos::Name != N(AA11)");
  WASM_ASSERT(eos::Name(eos::string_to_name("11AA")).value == N(11),
              "eos::Name != N(11)");
  WASM_ASSERT(eos::Name(eos::string_to_name("22BBCCXXAA")).value == N(22),
              "eos::Name != N(22)");
  WASM_ASSERT(eos::Name(eos::string_to_name("AAAbbcccdd")) ==
                  eos::Name(eos::string_to_name("AAAbbcccdd")),
              "eos::Name == eos::Name");
