...
static const char test4[] = "abcdefghbcdefghicdefghijdefghijkefghijklfghijklmgh"
...
unsigned int test_crypto::test_sha256() {
  ...
  WASM_ASSERT(my_memcmp((void *)test1_ok, &tmp, sizeof(uint256)),
              "sha256 test1");

  sha256((char *)test3, my_strlen(test3), &tmp);
  WASM_ASSERT(my_memcmp((void *)test3_ok, &tmp, sizeof(uint256)),
              "sha256 test3");

  sha256((char *)test4, my_strlen(test4), &tmp);
  WASM_ASSERT(my_memcmp((void *)test4_ok, &tmp, sizeof(uint256)),
              "sha256 test4");

  sha256((char *)test5, my_strlen(test5), &tmp);
  WASM_ASSERT(my_memcmp((void *)test5_ok, &tmp, sizeof(uint256)),
              "sha256 test5");
...
unsigned int test_crypto::sha256_no_data() {
  ...
  WASM_ASSERT(my_memcmp((void *)test2_ok, &tmp, sizeof(uint256)),
              "sha256 test2");
