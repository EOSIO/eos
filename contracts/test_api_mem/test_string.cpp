...
void test_string::concatenation_non_null_terminated() {
...
void test_string::comparison_operator() {
  char data1[] = "abcdefghij";
  size_t size1 = sizeof(data1)/sizeof(char);
  eosio::string str1(data1, size1, false);
...
void test_string::print_non_null_terminated() {
...
void test_string::print_unicode() {
  char data[] = "你好，世界！";
...
void test_string::string_literal() {
  // Construct
  char data1[] = "abcdefghij";
