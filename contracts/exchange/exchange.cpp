...
namespace eosio {
   ...
   void exchange::on( const createx& c ) {
      ...
      auto exchange_symbol = c.initial_supply.get_symbol().name();
      ...
      exstates.emplace( c.creator, [&]( auto& s ) {
          ...
          s.base.peer_margin.total_lent.set_extended_symbol(c.base_deposit.get_extended_symbol());
          s.base.peer_margin.total_lendable.set_extended_symbol(c.base_deposit.get_extended_symbol());

          s.quote.peer_margin.total_lent.set_extended_symbol(c.quote_deposit.get_extended_symbol());
          s.quote.peer_margin.total_lendable.set_extended_symbol(c.quote_deposit.get_extended_symbol());
      });
      ...
      _excurrencies.create_currency( { .issuer = _this_contract,
                                ...
                                .maximum_supply = asset( 0, c.initial_supply.get_symbol() ),
