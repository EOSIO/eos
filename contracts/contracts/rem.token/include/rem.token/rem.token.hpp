...
namespace eosio {
   ...
   /**
    * @defgroup eosiotoken rem.token
    * @ingroup eosiocontracts
    * 
    * rem.token contract
    * 
    * @details rem.token contract defines the structures and actions that allow users to create, issue, and manage
    * tokens on eosio based blockchains.
    * @{
    */
   class [[eosio::contract("rem.token")]] token : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiotoken rem.token
} /// namespace eosio
