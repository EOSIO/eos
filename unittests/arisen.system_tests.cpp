...
BOOST_FIXTURE_TEST_CASE( stake_unstake, arisen_system_tester ) try {
   ...
   const auto init_eosio_stake_balance = get_balance( N(arisen.stake) );
   ...
   BOOST_REQUIRE_EQUAL( init_eosio_stake_balance + core_from_string("300.0000"), get_balance( N(arisen.stake) ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( init_eosio_stake_balance, get_balance( N(arisen.stake) ) );
