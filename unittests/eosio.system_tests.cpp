...
public:
   ...
   transaction_trace_ptr setup_producer_accounts( const std::vector<account_name>& accounts ) {
      ...
      signed_transaction trx;
      set_transaction_headers(trx);
      asset cpu = asset::from_string("80.0000 SYS");
      asset net = asset::from_string("80.0000 SYS");
      asset ram = asset::from_string("1.0000 SYS");
   ...
   asset get_balance( const account_name& act ) {
      ...
      vector<char> data = get_row_by_account( N(eosio.token), act, N(accounts), symbol(SY(4,SYS)).to_symbol_code().value );
      return data.empty() ? asset(0, symbol(SY(4,SYS))) : token_abi_ser.binary_to_variant("account", data)["balance"].as<asset>();
   }
   ...
   asset get_token_supply() {
      return get_stats("4,SYS")["supply"].as<asset>();
   }
...
BOOST_FIXTURE_TEST_CASE( buysell, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( asset::from_string("1000000000.0000 SYS"), get_balance( "eosio" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("0.0000 SYS"), get_balance( "alice1111111" ) );

   transfer( "eosio", "alice1111111", "1000.0000 SYS", "eosio" );
   BOOST_REQUIRE_EQUAL( success(), stake( "eosio", "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );

   auto total = get_total_stake( "alice1111111" );
   auto init_bytes =  total["ram_bytes"].as_uint64();

   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "200.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("800.0000 SYS"), get_balance( "alice1111111" ) );
   ...
   BOOST_REQUIRE_EQUAL( asset::from_string("999.9999 SYS"), get_balance( "alice1111111" ) );
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( true, total["ram_bytes"].as_uint64() == init_bytes );

   transfer( "eosio", "alice1111111", "100000000.0000 SYS", "eosio" );
   BOOST_REQUIRE_EQUAL( asset::from_string("100000999.9999 SYS"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10000000.0000 SYS" ) );
   ...
   BOOST_REQUIRE_EQUAL( true, total["ram_bytes"].as_uint64() == init_bytes );
   BOOST_REQUIRE_EQUAL( asset::from_string("100000999.9993 SYS"), get_balance( "alice1111111" ) );


   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "30.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("100000439.9993 SYS"), get_balance( "alice1111111" ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111", bought_bytes ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("100000999.9991 SYS"), get_balance( "alice1111111" ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10000000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "10000000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "100000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111", "alice1111111", "300000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("49400999.9991 SYS"), get_balance( "alice1111111" ) );
   ...
   BOOST_REQUIRE_EQUAL( asset::from_string("100000999.9943 SYS"), get_balance( "alice1111111" ) );

} FC_LOG_AND_RETHROW()

BOOST_FIXTURE_TEST_CASE( stake_unstake, eosio_system_tester ) try {
   //issue( "eosio", "1000.0000 SYS", config::system_account_name );

   BOOST_REQUIRE_EQUAL( asset::from_string("1000000000.0000 SYS"), get_balance( "eosio" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("0.0000 SYS"), get_balance( "alice1111111" ) );
   transfer( "eosio", "alice1111111", "1000.0000 SYS", "eosio" );
   BOOST_REQUIRE_EQUAL( asset::from_string("999999000.0000 SYS"), get_balance( "eosio" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("1000.0000 SYS"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( success(), stake( "eosio", "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );

   auto total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( asset::from_string("210.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("110.0000 SYS"), total["cpu_weight"].as<asset>());

   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", "200.0000 SYS", "100.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   ...
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("210.0000 SYS").amount, total["net_weight"].as<asset>().amount );
   BOOST_REQUIRE_EQUAL( asset::from_string("110.0000 SYS").amount, total["cpu_weight"].as<asset>().amount );

   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "300.0000 SYS"), get_voter_info( "alice1111111" ) );

   auto bytes = total["ram_bytes"].as_uint64();
   BOOST_REQUIRE_EQUAL( true, 0 < bytes );

   //unstake from bob111111111
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "bob111111111", "200.0000 SYS", "100.0000 SYS" ) );
   total = get_total_stake("bob111111111");
   BOOST_REQUIRE_EQUAL( asset::from_string("10.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("10.0000 SYS"), total["cpu_weight"].as<asset>());
   produce_block( fc::hours(3*24-1) );
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   //after 3 days funds should be released
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "0.0000 SYS" ), get_voter_info( "alice1111111" ) );
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( asset::from_string("1000.0000 SYS"), get_balance( "alice1111111" ) );
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( "eosio", "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );
   ...
   //BOOST_REQUIRE_EQUAL( asset::from_string("999999700.0000 SYS"), get_balance( "eosio" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("0.0000 SYS"), get_balance( "alice1111111" ) );
   ...
   total = get_total_stake("alice1111111");
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("410.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("210.0000 SYS"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "600.0000 SYS"), get_voter_info( "alice1111111" ) );

   //alice can unstake everything (including what was transfered)
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "alice1111111", "400.0000 SYS", "200.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("700.0000 SYS"), get_balance( "alice1111111" ) );
   ...
   produce_block( fc::hours(1) );
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( asset::from_string("1300.0000 SYS"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, eosio_system_tester ) try {
   issue( "alice1111111", "1000.0000 SYS",  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "eosio", "alice1111111", "2000.0000 SYS", "1000.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", "10.0000 SYS", "10.0000 SYS" ) );
   ...
   BOOST_REQUIRE_EQUAL( error("missing authority of alice1111111"),
                        push_action(N(alice1111111), N(undelegatebw), mvo()
                                    ("from",     "alice1111111")
                                    ("receiver", "bob111111111")
                                    ("unstake_net_quantity", "200.0000 SYS")
                                    ("unstake_cpu_quantity", "100.0000 SYS")
                                    ("transfer", 0 )
                                    ,false
                        )
   );
...
BOOST_FIXTURE_TEST_CASE( stake_negative, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must stake a positive amount"),
                        stake( "alice1111111", "-0.0001 SYS", "0.0000 SYS" )
   );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must stake a positive amount"),
                        stake( "alice1111111", "0.0000 SYS", "-0.0001 SYS" )
   );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must stake a positive amount"),
                        stake( "alice1111111", "00.0000 SYS", "00.0000 SYS" )
   );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must stake a positive amount"),
                        stake( "alice1111111", "0.0000 SYS", "00.0000 SYS" )
   );
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", "200.0001 SYS", "100.0001 SYS" ) );

   auto total = get_total_stake( "bob111111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("210.0001 SYS"), total["net_weight"].as<asset>());
   auto vinfo = get_voter_info("alice1111111" );
   wdump((vinfo));
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "300.0002 SYS" ), get_voter_info( "alice1111111" ) );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must unstake a positive amount"),
                        unstake( "alice1111111", "bob111111111", "-1.0000 SYS", "0.0000 SYS" )
   );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must unstake a positive amount"),
                        unstake( "alice1111111", "bob111111111", "0.0000 SYS", "-1.0000 SYS" )
   );

   //unstake all zeros
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: must unstake a positive amount"),
                        unstake( "alice1111111", "bob111111111", "0.0000 SYS", "0.0000 SYS" )
   );
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, eosio_system_tester ) try {
   issue( "alice1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "200.0000 SYS", "100.0000 SYS" ) );
   ...
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: insufficient staked net bandwidth"),
                        unstake( "alice1111111", "200.0001 SYS", "0.0000 SYS" )
   );
   ...
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: insufficient staked cpu bandwidth"),
                        unstake( "alice1111111", "0.0000 SYS", "100.0001 SYS" )
   );
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: unable to find key"),
                        unstake( "bob111111111", "0.0000 SYS", "10.0000 SYS" )
   );

   issue( "carol1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "bob111111111", "20.0000 SYS", "10.0000 SYS" ) );
   total = get_total_stake( "bob111111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("230.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("120.0000 SYS"), total["cpu_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("970.0000 SYS"), get_balance( "carol1111111" ) );
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111", "30.0000 SYS" ), get_voter_info( "carol1111111" ) );

   //alice1111111 should not be able to unstake money staked by carol1111111
   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: insufficient staked net bandwidth"),
                        unstake( "alice1111111", "bob111111111", "2001.0000 SYS", "1.0000 SYS" )
   );

   BOOST_REQUIRE_EQUAL( error("condition: assertion failed: insufficient staked cpu bandwidth"),
                        unstake( "alice1111111", "bob111111111", "1.0000 SYS", "101.0000 SYS" )
   );
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, eosio_system_tester ) try {
   ...
   //everything at once
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "10.0000 SYS", "20.0000 SYS" ) );
   auto total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("20.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("30.0000 SYS"), total["cpu_weight"].as<asset>());

   //cpu
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "100.0000 SYS", "0.0000 SYS" ) );
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("120.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("30.0000 SYS"), total["cpu_weight"].as<asset>());

   //net
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "0.0000 SYS", "200.0000 SYS" ) );
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("120.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("230.0000 SYS"), total["cpu_weight"].as<asset>());

   //unstake cpu
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "100.0000 SYS", "0.0000 SYS" ) );
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("20.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("230.0000 SYS"), total["cpu_weight"].as<asset>());

   //unstake net
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "0.0000 SYS", "200.0000 SYS" ) );
   total = get_total_stake( "alice1111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("20.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("30.0000 SYS"), total["cpu_weight"].as<asset>());
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "bob111111111", "100.0000 SYS", "50.0000 SYS" ) );

   auto total = get_total_stake( "bob111111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("310.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("160.0000 SYS"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "450.0000 SYS" ), get_voter_info( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("550.0000 SYS"), get_balance( "alice1111111" ) );

   //unstake a share
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "bob111111111", "150.0000 SYS", "75.0000 SYS" ) );

   total = get_total_stake( "bob111111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("160.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("85.0000 SYS"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "225.0000 SYS" ), get_voter_info( "alice1111111" ) );

   //unstake more
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "bob111111111", "50.0000 SYS", "25.0000 SYS" ) );
   total = get_total_stake( "bob111111111" );
   BOOST_REQUIRE_EQUAL( asset::from_string("110.0000 SYS"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( asset::from_string("60.0000 SYS"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111", "150.0000 SYS" ), get_voter_info( "alice1111111" ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( asset::from_string("850.0000 SYS"), get_balance( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   issue( "bob111111111", "2000.0000 SYS",  config::system_account_name );
   issue( "carol1111111", "3000.0000 SYS",  config::system_account_name );

   //bob111111111 makes stake
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "11.0000 SYS", "0.1111 SYS" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("1988.8889 SYS"), get_balance( "bob111111111" ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", "11.1111 SYS" ), get_voter_info( "bob111111111" ) );
   ...
   BOOST_TEST_REQUIRE( stake2votes("11.1111 SYS") == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( "alice1111111", prod["owner"].as_string() );
   BOOST_REQUIRE_EQUAL( "http://block.one", prod["url"].as_string() );

   //carol1111111 makes stake
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "22.0000 SYS", "0.2222 SYS" ) );
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111", "22.2222 SYS" ), get_voter_info( "carol1111111" ) );
   BOOST_REQUIRE_EQUAL( asset::from_string("2977.7778 SYS"), get_balance( "carol1111111" ) );
   ...
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes("33.3333 SYS") == prod["total_votes"].as_double() );

   //bob111111111 increases his stake
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "55.0000 SYS", "0.5555 SYS" ) );
   //should increase alice1111111's total_votes
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes("88.8888 SYS") == prod["total_votes"].as_double() );

   //carol1111111 unstakes part of the stake
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", "2.0000 SYS", "0.0002 SYS"/*"2.0000 SYS", "0.0002 SYS"*/ ) );
   //should decrease alice1111111's total_votes
   prod = get_producer_info( "alice1111111" );
   wdump((prod));
   BOOST_TEST_REQUIRE( stake2votes("86.8886 SYS") == prod["total_votes"].as_double() );
   ...
   //should decrease alice1111111's total_votes
   prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes("20.2220 SYS") == prod["total_votes"].as_double() );
   //but eos should still be at stake
   BOOST_REQUIRE_EQUAL( asset::from_string("1933.3334 SYS"), get_balance( "bob111111111" ) );

   //carol1111111 unstakes rest of eos
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", "20.0000 SYS", "0.2220 SYS" ) );
   ...
   produce_block();
   BOOST_REQUIRE_EQUAL( asset::from_string("3000.0000 SYS"), get_balance( "carol1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue( "bob111111111", "2000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "13.0000 SYS", "0.5791 SYS" ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", "13.5791 SYS" ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, eosio_system_tester ) try {
   issue( "bob111111111", "2000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "50.0000 SYS", "50.0000 SYS" ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", "100.0000 SYS" ), get_voter_info( "bob111111111" ) );
...
BOOST_FIXTURE_TEST_CASE( producer_keep_votes, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   auto prod = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes("13.5791 SYS") == prod["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   issue( "carol1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "15.0005 SYS", "5.0000 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), push_action(N(carol1111111), N(voteproducer), mvo()
                                               ("voter",  "carol1111111")
                                               ("proxy", name(0).to_string() )
   ...
   BOOST_TEST_REQUIRE( stake2votes("20.0005 SYS") == alice_info["total_votes"].as_double() );
   auto bob_info = get_producer_info( "bob111111111" );
   BOOST_TEST_REQUIRE( stake2votes("20.0005 SYS") == bob_info["total_votes"].as_double() );
   ...
   issue( "alice1111111", "2.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "1.0000 SYS", "1.0000 SYS" ) );
   ...
   alice_info = get_producer_info( "alice1111111" );
   BOOST_TEST_REQUIRE( stake2votes("22.0005 SYS") == alice_info["total_votes"].as_double() );

   bob_info = get_producer_info( "bob111111111" );
   BOOST_TEST_REQUIRE( stake2votes("2.0000 SYS") == bob_info["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, eosio_system_tester ) try {
   ...
   issue( "bob111111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "200.0002 SYS", "100.0001 SYS" ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111", "300.0003 SYS" ), get_voter_info( "bob111111111" ) );
   ...
   issue( "carol1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "246.0002 SYS", "531.0001 SYS" ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111", "777.0003 SYS" ), get_voter_info( "carol1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, eosio_system_tester ) try {
   ...
   //stake
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "100.0000 SYS", "50.0000 SYS" ) );
   //check that account is still a proxy
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111" )( "staked", 1500000 ), get_voter_info( "alice1111111" ) );

   //stake more
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "30.0000 SYS", "20.0000 SYS" ) );
   //check that account is still a proxy
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111" )("staked", 2000000 ), get_voter_info( "alice1111111" ) );

   //unstake more
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "65.0000 SYS", "35.0000 SYS" ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   issue( "bob111111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "100.0002 SYS", "50.0001 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), push_action(N(bob111111111), N(voteproducer), mvo()
                                               ("voter",  "bob111111111")
                                               ("proxy", "alice1111111" )
                                               ("producers", vector<account_name>() )
   ...
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111" )( "proxied_vote_weight", stake2votes("150.0003 SYS") ), get_voter_info( "alice1111111" ) );
   ...
   BOOST_TEST_REQUIRE( stake2votes("150.0003 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("150.0003 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes("150.0003 SYS") == get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   //REQUIRE_MATCHING_OBJECT( voter( "alice1111111" )( "proxied_vote_weight", stake2votes("150.0003 SYS") ), get_voter_info( "alice1111111" ) );
   ...
   issue( "alice1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "30.0001 SYS", "20.0001 SYS" ) );
   BOOST_REQUIRE_EQUAL( stake2votes("200.0005 SYS"), get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( stake2votes("200.0005 SYS"), get_producer_info( "defproducer3" )["total_votes"].as_double() );

   //stake decrease by proxy itself affects producers
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111", "10.0001 SYS", "10.0001 SYS" ) );
   BOOST_TEST_REQUIRE( stake2votes("180.0003 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("180.0003 SYS") == get_producer_info( "defproducer3" )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE(producer_pay, eosio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   create_account_with_resources( N(defproducera), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(defproducerb), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(defproducerc), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );

   create_account_with_resources( N(producvotera), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterb), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   ...
   transfer( config::system_account_name, "producvotera", "400000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvotera", "100000000.0000 SYS", "100000000.0000 SYS"));
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, eosio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   const asset net = asset::from_string("80.0000 SYS");
   const asset cpu = asset::from_string("80.0000 SYS");
   create_account_with_resources( N(producvotera), config::system_account_name, asset::from_string("1.0000 SYS"), false, net, cpu );
   create_account_with_resources( N(producvoterb), config::system_account_name, asset::from_string("1.0000 SYS"), false, net, cpu );
   create_account_with_resources( N(producvoterc), config::system_account_name, asset::from_string("1.0000 SYS"), false, net, cpu );
   ...
   {
      transfer( config::system_account_name, "producvotera", "100000000.0000 SYS", config::system_account_name );
      BOOST_REQUIRE_EQUAL(success(), stake("producvotera", "30000000.0000 SYS", "30000000.0000 SYS") );
      transfer( config::system_account_name, "producvoterb", "100000000.0000 SYS", config::system_account_name);
      BOOST_REQUIRE_EQUAL(success(), stake("producvoterb", "30000000.0000 SYS", "30000000.0000 SYS") );
      transfer( config::system_account_name, "producvoterc", "100000000.0000 SYS", config::system_account_name);
      BOOST_REQUIRE_EQUAL(success(), stake("producvoterc", "30000000.0000 SYS", "30000000.0000 SYS") );
   }
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, eosio_system_tester) try {
   ...
   const asset large_asset = asset::from_string("80.0000 SYS");
   create_account_with_resources( N(producvotera), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterb), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   create_account_with_resources( N(producvoterc), config::system_account_name, asset::from_string("1.0000 SYS"), false, large_asset, large_asset );
   ...
   transfer(config::system_account_name, "producvotera", "200000000.0000 SYS", config::system_account_name);
   
   BOOST_REQUIRE_EQUAL(success(), stake("producvotera", "70000000.0000 SYS", "70000000.0000 SYS"));
   BOOST_REQUIRE_EQUAL(success(), push_action(N(producvotera), N(voteproducer), mvo()
                                                ("voter",  "producvotera")
                                                ("proxy", name(0).to_string())
                                                ("producers", vector<account_name>(producer_names.begin(), producer_names.begin()+10))
   ...
   transfer(config::system_account_name, "producvoterb", "100000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterb", "4000000.0000 SYS", "4000000.0000 SYS"));
   transfer(config::system_account_name, "producvoterc", "100000000.0000 SYS", config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterc", "2000000.0000 SYS", "2000000.0000 SYS"));
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   ...
   BOOST_TEST_REQUIRE( stake2votes("50.0002 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("50.0002 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes("150.0003 SYS") == get_voter_info( "alice1111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("200.0005 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("200.0005 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );

   //carol1111111 chooses alice1111111 as a proxy
   issue( "carol1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "30.0001 SYS", "20.0001 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), push_action( N(carol1111111), N(voteproducer), mvo()
                                                ("voter",  "carol1111111")
                                                ("proxy", "alice1111111" )
                                                ("producers", vector<account_name>() )
   ...
   BOOST_TEST_REQUIRE( stake2votes("200.0005 SYS") == get_voter_info( "alice1111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("250.0007 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("250.0007 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );


   //proxied voter carol1111111 increases stake
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "50.0000 SYS", "70.0000 SYS" ) );
   BOOST_TEST_REQUIRE( stake2votes("320.0005 SYS") == get_voter_info( "alice1111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("370.0007 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("370.0007 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );

   //proxied voter bob111111111 decreases stake
   BOOST_REQUIRE_EQUAL( success(), unstake( "bob111111111", "50.0001 SYS", "50.0001 SYS" ) );
   BOOST_TEST_REQUIRE( stake2votes("220.0003 SYS") == get_voter_info( "alice1111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("270.0005 SYS") == get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("270.0005 SYS") == get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes("50.0001 SYS"), get_voter_info( "alice1111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("170.0002 SYS"), get_voter_info( "donald111111" )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("100.0003 SYS"), get_producer_info( "defproducer1" )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes("100.0003 SYS"), get_producer_info( "defproducer2" )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3" )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, eosio_system_tester ) try {
   ...
   issue( "alice1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "5.0000 SYS", "5.0000 SYS" ) );
   ...
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111" )( "proxied_vote_weight", stake2votes( "150.0003 SYS" ))( "staked", 100000 ), get_voter_info( "alice1111111" ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111" )( "proxied_vote_weight", stake2votes("150.0003 SYS") )( "staked", 100000 ), get_voter_info( "alice1111111" ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, eosio_system_tester ) try {
   ...
   issue( "carol1111111", "1000.0000 SYS",  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", "100.0002 SYS", "50.0001 SYS" ) );
   BOOST_REQUIRE_EQUAL( success(), push_action( N(carol1111111), N(voteproducer), mvo()
                                                ("voter",  "carol1111111")
                                                ("proxy", "alice1111111" )
                                                ("producers", vector<account_name>() )
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, eosio_system_tester ) try {
   ...
   //stake more than 15% of total EOS supply to activate chain
   transfer( "eosio", "alice1111111", "600000000.0000 SYS", "eosio" );
   ...
   // elect 2 producers
   issue( "bob111111111", "80000.0000 SYS",  config::system_account_name );
   ilog("stake");
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", "40000.0000 SYS", "40000.0000 SYS" ) );
   ilog("start vote");
   BOOST_REQUIRE_EQUAL( success(), push_action(N(bob111111111), N(voteproducer), mvo()
                                               ("voter",  "bob111111111")
                                               ("proxy", name(0).to_string() )
