...
#### 2.1.2 Propose the transaction to create the eosio.wrap account
...
#### 2.1.3 Review and approve the transaction to create the eosio.wrap account
...
#### 2.1.4 Execute the transaction to create the eosio.wrap account
...
### 2.2 Deploy the eosio.wrap contract
...
#### 2.2.2 Propose the transaction to deploy the eosio.wrap contract
...
#### 2.2.3 Review and approve the transaction to deploy the eosio.wrap contract
...
#### 2.2.4 Execute the transaction to create the eosio.wrap account
...
## 3. Using the eosio.wrap contract
