...
BOOST_FIXTURE_TEST_CASE( stake_unstake, enumivo_system_tester ) try {
   ...
   const auto init_enumivo_stk_balance = get_balance( N(enumivo.stk) );
   ...
   BOOST_REQUIRE_EQUAL( init_enumivo_stk_balance + core_from_string("300.0000"), get_balance( N(enumivo.stk) ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111" ) );
   BOOST_REQUIRE_EQUAL( init_enumivo_stk_balance, get_balance( N(enumivo.stk) ) );
...
BOOST_FIXTURE_TEST_CASE(multiple_producer_pay, enumivo_system_tester, * boost::unit_test::tolerance(1e-10)) try {
...

   {
      ...
      BOOST_REQUIRE_EQUAL( error("missing authority of enumivo"),
...
BOOST_FIXTURE_TEST_CASE( setparams, enumivo_system_tester ) try {
   ...
   enumivo::chain::chain_config params;
