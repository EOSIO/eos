...
BOOST_AUTO_TEST_SUITE(float_exprs_78)

const string wasm_str = base_dir + "/wasm_spec_tests/wasms/float_exprs.78.wasm";
std::vector<uint8_t> wasm = read_wasm(wasm_str.c_str());

BOOST_AUTO_TEST_CASE(float_exprs_78_sub_apply_0) { try {
   TESTER tester;
