...
BOOST_AUTO_TEST_SUITE(int_exprs_13)

const string wasm_str = base_dir + "/wasm_spec_tests/wasms/int_exprs.13.wasm";
std::vector<uint8_t> wasm = read_wasm(wasm_str.c_str());

BOOST_AUTO_TEST_CASE(int_exprs_13_sub_apply_0) { try {
   TESTER tester;
