...
BOOST_AUTO_TEST_SUITE(memory_size_1)

const string wasm_str = base_dir + "/wasm_spec_tests/wasms/memory_size.1.wasm";
std::vector<uint8_t> wasm = read_wasm(wasm_str.c_str());

BOOST_AUTO_TEST_CASE(memory_size_1_sub_apply_0) { try {
   TESTER tester;
