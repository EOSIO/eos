...
BOOST_AUTO_TEST_SUITE(memory_grow_2)

const string wasm_str = base_dir + "/wasm_spec_tests/wasms/memory_grow.2.wasm";
std::vector<uint8_t> wasm = read_wasm(wasm_str.c_str());

BOOST_AUTO_TEST_CASE(memory_grow_2_sub_apply_0) { try {
   TESTER tester;
