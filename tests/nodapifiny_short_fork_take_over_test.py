...
###############################################################
# nodapifiny_short_fork_take_over_test
#
# Similar scenario to nodapifiny_forked_chain_test, except that there are only 3 producers and, after the "bridge" node is
...
try:
    ...
    if cluster.launch(prodCount=2, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      useBiosBootFile=False, specificExtraNodapifinyArgs=specificExtraNodapifinyArgs, onlySetProds=True) is False:
