...
###############################################################
# enunode_run_remote_test
#  Tests remote capability of the enunode_run_test. Test will setup cluster and pass nodes info to enunode_run_test. E.g.
#  enunode_run_remote_test.py -v --clean-run --dump-error-detail
###############################################################
...
try:
    ...
    TestHelper.shutdown(cluster, None, testSuccessful, killEnuInstances, False, False, killAll, dumpErrorDetails)
