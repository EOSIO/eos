...
BOOST_AUTO_TEST_CASE(basic_simple_symbol_table_test) {
  try {
    ...
    BOOST_CHECK_THROW(table.addType({"test type", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"Testtype[]", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"Testtype]", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"Testtype[", "", {{"f1", "String"}}}),
    ...
    BOOST_CHECK_THROW(table.addType({"Testtype!", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"_Testtype", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"Testtype_", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    BOOST_CHECK_THROW(table.addType({"Test_type", "", {{"f1", "String"}}}),
                      invalid_type_name_exception);
    ...
    BOOST_CHECK_THROW(table.addTypeDef("Testtype", "Testtype"),
                      duplicate_type_exception);
    BOOST_CHECK_THROW(table.addTypeDef("Testtype5", "NewType"),
                      unknown_type_exception);
    table.addTypeDef("Testtype", "TestType");
    BOOST_CHECK_THROW(table.addTypeDef("Testtype", "TestType"),
                      duplicate_type_exception);
    BOOST_CHECK_THROW(table.addTypeDef("Testtype", "NewType[]"),
                      type_exception);
    ...
    BOOST_CHECK_THROW(table.addType({"Foo", "Bar", {{"f1", "String"}}}),
                      unknown_type_exception);
    BOOST_CHECK_THROW(table.addType({"Foo", "Foo", {{"f1", "String"}}}),
                      unknown_type_exception);
    BOOST_CHECK_THROW(table.addType({"Foo", "", {{"f1", "Bar"}}}),
                      unknown_type_exception);
    BOOST_CHECK_THROW(table.addType({"Foo", "", {{"f1", "Foo"}}}),
                      unknown_type_exception);
    ...
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{"F1", "Struct"}}}),
                      invalid_field_name_exception);
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{"f!", "Struct"}}}),
                      invalid_field_name_exception);
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{"fg ", "Struct"}}}),
                      invalid_field_name_exception);
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{"f g", "Struct"}}}),
                      invalid_field_name_exception);
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{" fg", "Struct"}}}),
                      invalid_field_name_exception);
    BOOST_CHECK_THROW(table.addType({"Bar", "", {{"0fg", "Struct"}}}),
                      invalid_field_name_exception);
