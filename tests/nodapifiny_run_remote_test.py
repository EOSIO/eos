...
###############################################################
# nodapifiny_run_remote_test
#
#  Tests remote capability of the nodapifiny_run_test. Test will setup cluster and pass nodes info to nodapifiny_run_test. E.g.
#  nodapifiny_run_remote_test.py -v --clean-run --dump-error-detail
#
###############################################################
...
pnodes=1
total_nodes=pnodes
actualTest="tests/nodapifiny_run_test.py"
...
try:
    ...
    Print("Starting up %s test: %s" % ("nodapifiny", actualTest))
    Print("cmd: %s\n" % (cmd))
