...
def runNodeosAndGetOutput(myTimeout=3):
    ...
    cmd="programs/nodeos/nodeos --config-dir etc/eosio/cluster00000/node_bios --data-dir var/lib/cluster00000/node_bios --verbose-http-errors --http-validate-host=false"
    Print("cmd: %s" % (cmd))
