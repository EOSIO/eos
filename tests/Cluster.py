...
class Cluster(object):
    ...
    def launch(self, pnodes=1, totalNodes=1, prodCount=1, topo="mesh", p2pPlugin="net", delay=1, onlyBios=False, dontKill=False
        ...
        specificExtraAosArgs: dictionary of arguments to pass to a specific node (via --specific-num and
                                 --specific-aos flags on launcher), example: { "5" : "--plugin eosio::test_control_api_plugin" }
        """
        ...
        if not self.walletd:
            aosArgs += " --plugin eosio::wallet_api_plugin"
        if self.enableMongo:
            aosArgs += " --plugin eosio::mongo_db_plugin --mongodb-wipe --delete-all-blocks --mongodb-uri %s" % self.mongoUri
