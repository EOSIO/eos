...
class P2PTestPeers:
    ...
    ports = [6620] # arisend listening port of each host
    ...
    #ports = [6620, 6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620,6620, 6620] # arisend listening port of each host
