configure_file("apifiny.doxygen.in" "${CMAKE_BINARY_DIR}/apifiny.doxygen")
...
if(NOT DOXYGEN_FOUND)
  ...
  set(DOXY_APIFINY_VERSION "${VERSION_FULL}" CACHE INTERNAL "Version string used in PROJECT_NUMBER.")
  ...
  if(BUILD_DOXYGEN)
    ...
    add_custom_target(contract_documentation ALL
      COMMAND "${DOXYGEN_EXECUTABLE}" "${CMAKE_BINARY_DIR}/apifiny.doxygen"
