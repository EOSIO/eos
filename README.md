...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.0/eosio-1.7.1-1.el7.x86_64.rpm
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.0/eosio-1.7.1-1.fc27.x86_64.rpm
