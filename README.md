...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.5.0-rc2/eosio-1.5.0-rc2-1.el7.x86_64.rpm
$ sudo yum install ./eosio-1.5.0-rc2-1.el7.x86_64.rpm
```
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.5.0-rc2/eosio-1.5.0-rc2-1.fc27.x86_64.rpm
$ sudo yum install ./eosio-1.5.0-rc2-1.fc27.x86_64.rpm
```
