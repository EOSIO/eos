...
```sh
$ wget https://github.com/eosio/eos/releases/download/v2.0.0-rc1/eosio_2.0.0-rc1-ubuntu-18.04_amd64.deb
$ sudo apt install ./eosio_2.0.0-rc1-ubuntu-18.04_amd64.deb
```
#### Ubuntu 16.04 Package Install
```sh
$ wget https://github.com/eosio/eos/releases/download/v2.0.0-rc1/eosio_2.0.0-rc1-ubuntu-16.04_amd64.deb
$ sudo apt install ./eosio_2.0.0-rc1-ubuntu-16.04_amd64.deb
```
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v2.0.0-rc1/eosio-2.0.0-rc1.el7.x86_64.rpm
$ sudo yum install ./eosio-2.0.0-rc1.el7.x86_64.rpm
```
