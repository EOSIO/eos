...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.7/eosio_1.7.7-1-ubuntu-18.04_amd64.deb
$ sudo apt install ./eosio_1.7.7-1-ubuntu-18.04_amd64.deb
```
#### Ubuntu 16.04 Debian Package Install
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.7/eosio_1.7.7-1-ubuntu-16.04_amd64.deb
$ sudo apt install ./eosio_1.7.7-1-ubuntu-16.04_amd64.deb
```
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.7/eosio-1.7.7-1.el7.x86_64.rpm
$ sudo yum install ./eosio-1.7.7-1.el7.x86_64.rpm
```
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.7.7/eosio-1.7.7-1.fc27.x86_64.rpm
$ sudo yum install ./eosio-1.7.7-1.fc27.x86_64.rpm
```
