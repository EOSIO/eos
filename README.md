...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.8.11/eosio_1.8.11-1-ubuntu-18.04_amd64.deb
$ sudo apt install ./eosio_1.8.11-1-ubuntu-18.04_amd64.deb
```
#### Ubuntu 16.04 Package Install
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.8.11/eosio_1.8.11-1-ubuntu-16.04_amd64.deb
$ sudo apt install ./eosio_1.8.11-1-ubuntu-16.04_amd64.deb
```
...
```sh
$ wget https://github.com/eosio/eos/releases/download/v1.8.11/eosio-1.8.11-1.el7.x86_64.rpm
$ sudo yum install ./eosio-1.8.11-1.el7.x86_64.rpm
```
