...
Stake tokens for the account that will be creating the `currency` account.

```bash
./eosioc set account stake 1000000 inita
```

You should then get a json response back with with a transaction ID confirming it was executed successfully.

Check that the amount was successfully staked.
...
{
  "account_name": "inita",
  "eos_balance": "999900.0000 EOS",
  "staked_balance": "100.0000 EOS",
