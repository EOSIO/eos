...
run(cleos + 'push action eosio.token create \'["eosio.token", "10000000000.0000 %s", 0, 0, 0]\' -p eosio.token' % (symbol))
run(cleos + 'push action eosio.token issue \'["eosio.token", "1000000000.0000 %s", "memo"]\' -p eosio.token' % (symbol))
time.sleep(1)
