...
int main(int argc, char** argv)
{
   try {
      ...
      app().set_default_data_dir(root / "arisen/aos/data" );
      app().set_default_config_dir(root / "arisen/aos/config" );
      ...
      initialize_logging();
      ilog("aOS version ${ver}", ("ver", app().version_string()));
      ilog("Arisen root is ${root}", ("root", root.string()));
      app().startup();
      app().exec();
