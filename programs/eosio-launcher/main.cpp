...
launcher_def::write_logging_config_file(tn_node_def &node) {
  ...
  auto str = fc::json::to_pretty_string( log_config, fc::time_point::max(), fc::json::output_formatting::stringify_large_ints_and_doubles );
...
launcher_def::write_setprods_file() {
  ...
  auto str = fc::json::to_pretty_string( no_bios, fc::time_point::max(), fc::json::output_formatting::stringify_large_ints_and_doubles );
