...
int main(int argc, char** argv)
{
   try {
      ...
      if(!app().initialize<chain_plugin, net_plugin, producer_plugin, resource_monitor_plugin, blockvault_client_plugin>(argc, argv)) { // TODO remove blockvault_client_plugin
