...
CDT_INSTALL_COMMAND="wget https://github.com/eosio/eosio.cdt/releases/download/v1.8.0/eosio.cdt_1.8.0-1-ubuntu-18.04_amd64.deb && apt install ./eosio.cdt_1.8.0-1-ubuntu-18.04_amd64.deb"
