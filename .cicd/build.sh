...
if [[ $(uname) == 'Darwin' ]]; then
    ...
    if [[ $IMAGE_TAG == 'amazon_linux-2' ]]; then
        ...
        CMAKE_EXTRAS="$CMAKE_EXTRAS -DLLVM_DIR='/opt/rh/llvm-toolset-7.0/root/lib64/cmake/llvm'"
    ...
    [[ "$BUILD_TYPE" == 'conan' ]] && COMMANDS="cd $MOUNTED_DIR && $MOUNTED_DIR/.conan/conan-build.sh && cp -r ~/.conan $MOUNTED_DIR/build/conan"
