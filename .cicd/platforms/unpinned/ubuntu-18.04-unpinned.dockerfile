...
RUN curl -LO https://github.com/EOSIO/cppKin/releases/download/v1.1.1/cppkin_1.1.1-ubuntu-18.04_amd64.deb && \
    apt install -y ./cppkin_1.1.1-ubuntu-18.04_amd64.deb && \
    rm ./cppkin_1.1.1-ubuntu-18.04_amd64.deb
# install nvm
